...
class RoleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('backend.buyer.access-control.roles.index', [
            'account' => $account,
    ...
    public function create()
    {
        ...
        return view('backend.buyer.access-control.roles.create', [
            'account'          => $account,
            'user'             => $this->currentUser(),
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('buyer.roles.index')
    ...
    public function edit(Role $role)
    {
        ...
        abort_if($role->is_system || $role->account_id !== $account->id, 403, 'System roles cannot be edited. Duplicate this role to customize permissions.');
        ...
        return view('backend.buyer.access-control.roles.edit', [
            'account'          => $account,
            'user'             => $this->currentUser(),
            'role'             => $role,
    ...
    public function duplicate(Request $request, Role $role)
    {
        ...
        return redirect()->route('buyer.roles.edit', $newRole)
