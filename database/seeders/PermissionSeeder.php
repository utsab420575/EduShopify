...
class PermissionSeeder extends Seeder
{
    ...
    private static function platform(): array
    {
        return [
            ...
            ['platform.achievements.manage', 'Platform · Achievements', 'platform', 'Manage the achievements catalogue'],
            ['platform.achievements.review', 'Platform · Achievements', 'platform', 'Review account achievement claims', ['sensitive']],
            ['platform.certifications.review', 'Platform · Achievements', 'platform', 'Review account certification submissions', ['sensitive']],
            ['platform.blog.manage', 'Platform · Blog', 'platform', 'Create, edit, and delete blog posts'],
            ['platform.blog.review', 'Platform · Blog', 'platform', 'Approve or reject submitted blog posts', ['sensitive']],
