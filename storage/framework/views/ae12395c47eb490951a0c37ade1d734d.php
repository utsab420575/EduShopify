...
<svg <?php echo e($attributes->merge(['class' => 'w-5 h-5'])); ?> fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php switch($name):
        ...
        <?php case ('chat-bubble-left-right'): ?>
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\components\dashboard\icon.blade.php ENDPATH**/ ?>