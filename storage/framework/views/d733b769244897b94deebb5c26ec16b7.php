<?php $__env->startSection('title', $subscription->supplierAccount?->supplierProfile?->display_name); ?>
<?php $__env->startSection('breadcrumb', 'Subscription & Billing / Subscriptions / ' . $subscription->supplierAccount?->supplierProfile?->display_name); ?>

<?php $__env->startSection('body'); ?>

    <?php if (isset($component)) { $__componentOriginal6ccefb989a1afce853acb3cdbc40307e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6ccefb989a1afce853acb3cdbc40307e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-header','data' => ['title' => $subscription->supplierAccount?->supplierProfile?->display_name,'subtitle' => $subscription->plan?->name ?? $subscription->plan_name_snapshot]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($subscription->supplierAccount?->supplierProfile?->display_name),'subtitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($subscription->plan?->name ?? $subscription->plan_name_snapshot)]); ?>
...
<?php endif; ?>
    ...
    <div class="flex flex-wrap items-center gap-2 mb-6">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($subscription->status, ['active', 'trialing'])): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.form-card','data' => ['title' => 'Subscription Details']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Subscription Details']); ?>
                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div><dt class="text-gray-500">Plan</dt><dd class="font-medium text-gray-900"><?php echo e($subscription->plan?->name ?? $subscription->plan_name_snapshot); ?></dd></div>
                    <div><dt class="text-gray-500">Price</dt><dd class="font-medium text-gray-900"><?php echo e(number_format($subscription->price_snapshot ?? 0, 2)); ?></dd></div>
                    <div><dt class="text-gray-500">Started</dt><dd class="font-medium text-gray-900"><?php echo e($subscription->starts_at?->format('d M Y') ?? '—'); ?></dd></div>
                    <div><dt class="text-gray-500">Trial Ends</dt><dd class="font-medium text-gray-900"><?php echo e($subscription->trial_ends_at?->format('d M Y') ?? '—'); ?></dd></div>
                    <div><dt class="text-gray-500">Current Period End</dt><dd class="font-medium text-gray-900"><?php echo e($subscription->current_period_end?->format('d M Y') ?? '—'); ?></dd></div>
                    <div><dt class="text-gray-500">Auto Renew</dt><dd class="font-medium text-gray-900"><?php echo e($subscription->auto_renew ? 'Yes' : 'No'); ?></dd></div>
                </dl>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subscription->cancellation_reason): ?>
                    <div class="mt-4 border-t border-gray-100 pt-4">
                        <p class="text-xs font-semibold text-gray-500 uppercase mb-1">Cancellation Reason</p>
                        <p class="text-sm text-gray-600"><?php echo e($subscription->cancellation_reason); ?></p>
                    </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($subscription->payments->isNotEmpty()): ?>
                <?php if (isset($component)) { $__componentOriginal3c6ebeac636fe1a833069360516dddbb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3c6ebeac636fe1a833069360516dddbb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.form-card','data' => ['title' => 'Payment History']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('backend.form-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Payment History']); ?>
                    <ul class="divide-y divide-gray-100 -mx-5 -mb-5">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $subscription->payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex items-center justify-between px-5 py-3">
                                <div>
                                    <p class="text-sm text-gray-800"><?php echo e(number_format($payment->amount, 2)); ?> <?php echo e($payment->currency_code); ?></p>
                                    <p class="text-xs text-gray-400"><?php echo e($payment->paid_at?->format('d M Y') ?? $payment->created_at->format('d M Y')); ?></p>
                                </div>
...
<?php unset($__componentOriginal1790892cf8031768f200c26522db45cd); ?>
<?php endif; ?>
                                    <a href="<?php echo e(route('admin.billing.payments.show', $payment)); ?>" class="text-sm font-medium" style="color:var(--theme-primary)">View</a>
                                </div>
                            </li>
...
<?php $component->withAttributes(['title' => 'Supplier']); ?>
                <p class="text-sm font-medium text-gray-900"><?php echo e($subscription->supplierAccount?->supplierProfile?->display_name); ?></p>
                <a href="<?php echo e(route('admin.suppliers.show', $subscription->supplierAccount)); ?>" class="text-sm font-medium mt-2 inline-block" style="color:var(--theme-primary)">View Supplier &rarr;</a>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3c6ebeac636fe1a833069360516dddbb)): ?>
<?php $attributes = $__attributesOriginal3c6ebeac636fe1a833069360516dddbb; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.modal','data' => ['id' => 'extend','title' => 'Extend Subscription']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'extend','title' => 'Extend Subscription']); ?>
            <form method="POST" action="<?php echo e(route('admin.billing.subscriptions.extend', $subscription)); ?>">
                <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.input','data' => ['name' => 'days','label' => 'Extend by (days)','type' => 'number','required' => true,'min' => '1','max' => '365']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'days','label' => 'Extend by (days)','type' => 'number','required' => true,'min' => '1','max' => '365']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal5845bcee7aa8bdff54827061cf154d18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5845bcee7aa8bdff54827061cf154d18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.modal','data' => ['id' => 'suspend','title' => 'Suspend Subscription']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('backend.modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'suspend','title' => 'Suspend Subscription']); ?>
            <form method="POST" action="<?php echo e(route('admin.billing.subscriptions.suspend', $subscription)); ?>">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
        <?php if (isset($component)) { $__componentOriginal5845bcee7aa8bdff54827061cf154d18 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5845bcee7aa8bdff54827061cf154d18 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.modal','data' => ['id' => 'cancel','title' => 'Cancel Subscription']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('backend.modal'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'cancel','title' => 'Cancel Subscription']); ?>
            <form method="POST" action="<?php echo e(route('admin.billing.subscriptions.cancel', $subscription)); ?>">
                <?php echo csrf_field(); ?>
                <?php if (isset($component)) { $__componentOriginalb5285f6ddae5fa9f0bdd5c8c6f8c1f6e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb5285f6ddae5fa9f0bdd5c8c6f8c1f6e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.textarea','data' => ['name' => 'reason','label' => 'Reason','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('backend.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\admin\billing\subscriptions\show.blade.php ENDPATH**/ ?>