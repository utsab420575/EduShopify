...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['label' => null, 'name', 'required' => false, 'hint' => null, 'type' => 'text']));
...
foreach (array_filter((['label' => null, 'name', 'required' => false, 'hint' => null, 'type' => 'text']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php /**PATH C:\laragon\www\edushopify\resources\views/components/backend/input.blade.php ENDPATH**/ ?>