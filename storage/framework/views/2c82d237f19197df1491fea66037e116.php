<?php $__env->startSection('title', 'Pricing Types'); ?>
<?php $__env->startSection('breadcrumb', 'Catalog & Taxonomy / Pricing Types'); ?>
...
<div x-data="{
    ...
    openCreate() {
        this.isEdit = false;
        this.formAction = '<?php echo e(route('admin.catalog.pricing-types.store')); ?>';
        this.form = { id: null, name: '', code: '', description: '', sort_order: 0, is_active: true };
        this.modalOpen = true;
    },
    openEdit(item) {
        this.isEdit = true;
        this.formAction = '<?php echo e(url('admin/catalog/pricing-types')); ?>/' + item.id;
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-header','data' => ['title' => 'Pricing Types','subtitle' => 'Define the pricing models available for supplier listings (e.g. Fixed Price, Quote Only, RFQ Enabled).']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Pricing Types','subtitle' => 'Define the pricing models available for supplier listings (e.g. Fixed Price, Quote Only, RFQ Enabled).']); ?>
...
<?php endif; ?>
    ...
    <div class="mb-4">
        <form method="GET" action="<?php echo e(route('admin.catalog.pricing-types.index')); ?>" class="flex flex-wrap items-center gap-3">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $status): ?>
                <a href="<?php echo e(route('admin.catalog.pricing-types.index')); ?>" class="text-xs text-gray-500 hover:text-gray-800">Clear</a>
    ...
    <?php
        $sortUrl = fn($col) => route('admin.catalog.pricing-types.index', array_merge(request()->except(['sort','direction','page']), [
            'sort'      => $col,
...
<?php $component->withAttributes([]); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pricingTypes->isEmpty()): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.empty-state','data' => ['icon' => 'fa-tag','title' => 'No pricing types found']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-tag','title' => 'No pricing types found']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?> <?php $__env->endSlot(); ?>
        <?php else: ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pricingTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                ...
                <td class="px-5 py-3.5 text-right">
                    <div class="flex items-center justify-end gap-1.5">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('platform.attributes.manage')): ?>
                        <form method="POST" action="<?php echo e(route('admin.catalog.pricing-types.toggle-active', $item)); ?>"
                              onsubmit="return confirmSwal(this, '<?php echo e($item->is_active ? 'Deactivate' : 'Activate'); ?> Pricing Type?', '<?php echo e(addslashes($item->name)); ?> will be <?php echo e($item->is_active ? 'hidden from suppliers' : 'available to suppliers'); ?>.', 'question', 'Yes, <?php echo e($item->is_active ? 'Deactivate' : 'Activate'); ?>')">
                            <?php echo csrf_field(); ?>
                            <button type="submit"
                        ...
                        <form method="POST" action="<?php echo e(route('admin.catalog.pricing-types.destroy', $item)); ?>"
                              onsubmit="return confirmSwal(this, 'Delete Pricing Type?', 'Delete <?php echo e(addslashes($item->name)); ?>? This cannot be undone.', 'warning', 'Yes, Delete')">
                            <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                            <button type="submit"
                                    class="w-8 h-8 rounded-lg inline-flex items-center justify-center text-red-500 hover:bg-red-50 transition"
                                    title="Delete">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.pagination','data' => ['paginator' => $pricingTypes]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($pricingTypes)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            <div x-show="modalOpen"
                ...
                <form :action="formAction" method="POST">
                    ...
                    <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/50">
                        <div>
                            <h3 class="text-base font-bold text-gray-900" x-text="isEdit ? 'Edit Pricing Type' : 'New Pricing Type'"></h3>
                            <p class="text-xs text-gray-500 mt-0.5">Define a pricing model that suppliers can select for their listings.</p>
                        </div>
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" x-model="form.name" required placeholder="e.g. Fixed Catalog Price"
                        ...
                        <div>
                            ...
                            <input type="text" name="code" x-model="form.code" required placeholder="e.g. fixed" maxlength="50"
                                   :readonly="isEdit"
                            ...
                            <p class="text-[11px] text-gray-400 mt-1">Unique slug (letters, numbers, underscores). Used by business logic — cannot be changed after creation.</p>
                        </div>

                        <div>
                            <label class="block text-xs font-semibold text-gray-700 mb-1">Description</label>
                            <textarea name="description" x-model="form.description" rows="2" placeholder="Short description shown to suppliers..."
                            ...
                            <div class="flex items-center pt-5">
                                <label class="inline-flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" name="is_active" value="1" x-model="form.is_active"
                                           class="rounded" style="accent-color:var(--theme-primary)">
                    ...
                    <div class="px-6 py-3.5 bg-gray-50 border-t border-gray-100 flex items-center justify-end gap-2.5 rounded-b-2xl">
                        ...
                        <button type="submit" class="btn-primary text-xs font-semibold px-5 py-2 rounded-lg flex items-center gap-1.5 shadow-xs">
                            ...
                            <span x-text="isEdit ? 'Save Changes' : 'Create Pricing Type'"></span>
                        </button>
                    </div>
                </form>
            </div>
...
<?php echo $__env->make('backend.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\admin\catalog\pricing-types\index.blade.php ENDPATH**/ ?>