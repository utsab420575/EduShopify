...
<th class="align-top px-4 py-4 text-left" style="width:220px;min-width:220px;border-left:1px solid var(--fe-border);background:var(--fe-surface);">
    <div class="relative">
        ...
        <div class="comparison-hide-print space-y-1.5">
            ...
            <a :href="<?php echo e(auth()->check() ? "'/buyer/rfqs/create?listing=' + item.listing_id" : "'/handoff/request-quote/' + item.slug"); ?>"
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\frontend\components\marketplace\comparison-header.blade.php ENDPATH**/ ?>