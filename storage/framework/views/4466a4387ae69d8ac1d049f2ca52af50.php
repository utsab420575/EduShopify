...
<div x-data="categoryAttributesManager({
    initialCategoryId: <?php echo e(json_encode($initialCategoryId)); ?>,
    initialValues: <?php echo e(json_encode($initialValues)); ?>,
    endpointUrl: '<?php echo e($endpointUrl); ?>'
})"
     x-init="init()"
     class="space-y-6">
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\backend\supplier\catalog\listings\partials\attributes-form.blade.php ENDPATH**/ ?>