...
<?php $__env->startSection('breadcrumb', 'System & Settings / Failed Jobs'); ?>

<?php $__env->startSection('body'); ?>

    <?php if (isset($component)) { $__componentOriginal6ccefb989a1afce853acb3cdbc40307e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6ccefb989a1afce853acb3cdbc40307e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-header','data' => ['title' => 'Failed Jobs','subtitle' => 'Queued jobs that failed and need attention.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Failed Jobs','subtitle' => 'Queued jobs that failed and need attention.']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.empty-state','data' => ['icon' => 'fa-triangle-exclamation','title' => 'No failed jobs','description' => 'All queued jobs are processing normally.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-triangle-exclamation','title' => 'No failed jobs','description' => 'All queued jobs are processing normally.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <?php else: ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="hover:bg-gray-50">
                    <td class="px-5 py-3.5 text-sm font-medium text-gray-900"><?php echo e($job->queue); ?></td>
                    <td class="px-5 py-3.5 text-sm text-gray-600 max-w-md truncate" title="<?php echo e($job->exception); ?>"><?php echo e(\Illuminate\Support\Str::limit($job->exception, 120)); ?></td>
                    <td class="px-5 py-3.5 text-sm text-gray-600"><?php echo e(\Illuminate\Support\Carbon::parse($job->failed_at)->format('d M Y H:i')); ?></td>
                    <td class="px-5 py-3.5 text-right">
                        <div class="flex items-center justify-end gap-1.5">
                            <form method="POST" action="<?php echo e(route('admin.system.jobs.retry', $job->uuid)); ?>">
                                <?php echo csrf_field(); ?>
                            ...
                            <form method="POST" action="<?php echo e(route('admin.system.jobs.destroy', $job->uuid)); ?>" onsubmit="return confirm('Discard this failed job permanently?');">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.pagination','data' => ['paginator' => $jobs]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('backend.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\admin\system\jobs\index.blade.php ENDPATH**/ ?>