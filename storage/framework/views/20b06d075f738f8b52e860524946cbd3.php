...
<section class="max-w-7xl mx-auto px-4 py-10" id="featured-suppliers-section">
  <div class="flex items-center justify-between mb-5">
    ...
    <div class="flex items-center gap-2.5">
      <a href="<?php echo e(route('v2.suppliers.index')); ?>" class="text-emerald-600 hover:text-emerald-700 text-sm font-medium hover:underline cursor-pointer">See all</a>
  ...
  <div class="relative">
    ...
    >
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $featuredSuppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="featured-supplier-item shrink-0 product-card-fade-up" style="animation-delay: <?php echo e($loop->index * 45); ?>ms">
...
<?php /**PATH C:\laragon\www\edushopify\resources\views/frontend_new/home/partial/_featured_suppliers.blade.php ENDPATH**/ ?>