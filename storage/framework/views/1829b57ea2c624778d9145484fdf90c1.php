...
<?php $__env->startSection('breadcrumb', 'Subscription & Billing / Payment History'); ?>

<?php $__env->startSection('body'); ?>

    <?php if (isset($component)) { $__componentOriginal6ccefb989a1afce853acb3cdbc40307e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6ccefb989a1afce853acb3cdbc40307e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-header','data' => ['title' => 'Payment History','subtitle' => 'View records of subscription payments and invoice receipts.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Payment History','subtitle' => 'View records of subscription payments and invoice receipts.']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.empty-state','data' => ['icon' => 'fa-receipt','title' => 'No payment records found','description' => 'Your subscription invoices and transaction receipts will appear here.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-receipt','title' => 'No payment records found','description' => 'Your subscription invoices and transaction receipts will appear here.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50">
                                <td class="px-5 py-3.5 font-mono font-bold text-gray-900">
                                    <?php echo e($payment->transaction_reference ?? 'PAY-' . $payment->id); ?>

                                </td>
                                <td class="px-3 py-3.5 font-medium text-gray-800">
                                    <?php echo e($payment->subscriptionPlan?->name ?? 'Subscription'); ?>

                                </td>
                                <td class="px-3 py-3.5 font-bold text-gray-900">
                                    <?php echo e($payment->currency_code); ?> <?php echo e(number_format($payment->amount, 2)); ?>

                                </td>
                                <td class="px-3 py-3.5 text-gray-500 uppercase">
                                    <?php echo e($payment->payment_method ?? 'Stripe'); ?>

                                </td>
                                <td class="px-3 py-3.5 text-gray-600">
                                    <?php echo e($payment->paid_at?->format('d M Y, h:i A')); ?>
...
<?php echo $__env->make('backend.layouts.supplier', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\supplier\subscription\payments.blade.php ENDPATH**/ ?>