    ...
    <div class="ml-auto flex items-center gap-2 sm:gap-3 lg:gap-4">
      ...
      <div class="flex items-center gap-2 sm:gap-3 pl-1 sm:pl-2">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
          <a href="<?php echo e(route('login')); ?>" class="text-sm font-medium text-gray-700 hover:text-gray-900 px-2 py-1.5 transition">Sign In</a>
          <a href="<?php echo e(route('register')); ?>" class="text-sm font-semibold bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-lg transition shadow-sm">Register</a>
        <?php else: ?>
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\frontend_new\partials\navbar.blade.php ENDPATH**/ ?>