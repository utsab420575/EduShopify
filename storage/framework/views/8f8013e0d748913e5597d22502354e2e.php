...
<?php $component->withAttributes([]); ?>
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
                ...
                <div class="lg:col-span-6 space-y-8">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 pt-2">
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 text-base font-semibold rounded-xl text-white bg-emerald-600 hover:bg-emerald-700 shadow-xl shadow-emerald-500/20 transform hover:-translate-y-0.5 transition-all duration-200">
                            Pre-Register Now
                ...
                <div class="lg:col-span-6 mt-16 lg:mt-0 relative flex flex-col items-center">
                    <!-- Hero Mockup Image -->
                    <img src="<?php echo e(asset('images/herosection.png')); ?>" alt="Edushopify Dashboard Preview" class="w-full max-w-[580px] h-auto object-contain">
    ...
    <div id="pricing-section" class="bg-white py-20 lg:py-28 border-t border-slate-200/50"
         x-data="{ billing: '<?php echo e($homeMonthlyPaid->isNotEmpty() ? 'monthly' : 'yearly'); ?>' }">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center mb-12">
                <div class="inline-flex items-center bg-slate-100 rounded-xl p-1 gap-1">
                    ...
                    <button @click="billing = 'yearly'"
                        ...
                        ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($homeSavePct > 0): ?>
                            <span class="bg-emerald-500 text-white text-[10px] px-2 py-0.5 rounded-full font-bold">Save <?php echo e($homeSavePct); ?>%</span>
            ...
            <div x-show="billing === 'monthly'"
                ...
                <div class="relative bg-white rounded-2xl p-8 border <?php echo e($plan->is_featured ? 'border-2 border-emerald-500 shadow-xl scale-[1.02]' : 'border-slate-200 shadow-sm hover:shadow-lg hover:border-slate-300'); ?> w-full md:w-1/3 max-w-[380px] flex flex-col justify-between transition-all duration-300">
                    ...
                    <div class="absolute <?php echo e($plan->is_featured ? 'top-4 right-4' : '-top-3 left-1/2 -translate-x-1/2'); ?>">
                        <span class="bg-amber-400 text-amber-900 text-[10px] font-bold px-3 py-1 rounded-full shadow-sm whitespace-nowrap">+<?php echo e($plan->bonus_days); ?> Bonus Days!</span>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="space-y-6">
                        <div>
                            ...
                            <h3 class="text-lg font-bold text-slate-900 font-display"><?php echo e($plan->name); ?></h3>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->check() && auth()->user()->isSupplier()): ?>
                        <a href="<?php echo e(route('supplier.pricing')); ?>" class="mt-8 block w-full text-center px-4 py-3 rounded-xl <?php echo e($plan->is_featured ? 'bg-emerald-500 hover:bg-emerald-600 text-white shadow-md shadow-emerald-500/10' : 'border border-slate-200 text-slate-700 hover:bg-slate-50'); ?> text-xs font-semibold transition-colors">
                            Choose <?php echo e($plan->name); ?>

                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>" class="mt-8 block w-full text-center px-4 py-3 rounded-xl <?php echo e($plan->is_featured ? 'bg-emerald-500 hover:bg-emerald-600 text-white shadow-md shadow-emerald-500/10' : 'border border-slate-200 text-slate-700 hover:bg-slate-50'); ?> text-xs font-semibold transition-colors">
                            <?php echo e($plan->isFree() ? 'Get Started Free' : 'Get Started'); ?>
            ...
            <div x-show="billing === 'yearly'"
                ...
                <div class="relative bg-white rounded-2xl p-8 border <?php echo e($plan->is_featured ? 'border-2 border-emerald-500 shadow-xl scale-[1.02]' : 'border-slate-200 shadow-sm hover:shadow-lg hover:border-slate-300'); ?> w-full md:w-1/3 max-w-[380px] flex flex-col justify-between transition-all duration-300">
                    ...
                    <span class="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-emerald-500 text-white text-[10px] font-bold rounded-full uppercase tracking-wider shadow font-sans">Best Value</span>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ySave): ?>
                    <div class="absolute top-4 right-4">
                        <span class="bg-emerald-100 text-emerald-700 text-[10px] font-bold px-2.5 py-1 rounded-full">Save <?php echo e($ySave['amount']); ?></span>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan->bonus_days > 0): ?>
                    <div class="absolute <?php echo e($plan->is_featured ? 'top-4 right-4' : '-top-3 left-1/2 -translate-x-1/2'); ?>">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <?php else: ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ySave): ?><p class="mt-1 text-xs text-emerald-600 font-semibold">Save <?php echo e($ySave['amount']); ?> vs monthly (<?php echo e($ySave['pct']); ?>% off)</p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan->bonus_days > 0): ?><p class="mt-1 text-xs text-amber-600 font-semibold">+ <?php echo e($plan->bonus_days); ?> bonus days</p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <?php echo $__env->make('supplier._plan-features', ['plan' => $plan], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    </div>
            ...
            <div class="lg:grid lg:grid-cols-12 lg:gap-12 items-center">
                ...
                <div class="lg:col-span-7 space-y-6">
                    ...
                    <div class="flex flex-wrap gap-4 items-center pt-2">
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center px-8 py-4 bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-bold rounded-xl shadow-lg transition-all text-sm sm:text-base duration-200">
    ...
    <div class="bg-white py-16 sm:py-24 border-t border-slate-200/50">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-gradient-to-tr from-emerald-600/5 via-teal-500/5 to-indigo-600/5 rounded-3xl border border-slate-100 p-8 sm:p-12 text-center space-y-6 shadow-sm">
                ...
                <div class="pt-2">
                    <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center px-8 py-3.5 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded-xl shadow-md transition-all">
                        Pre-Register Now
                    </a>
                </div>
            </div>
    ...
    <div class="bg-emerald-50 border-t border-b border-emerald-100 py-4">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a href="<?php echo e(route('register')); ?>" class="px-5 py-2 bg-emerald-500 hover:bg-emerald-600 text-white font-bold rounded-lg text-xs shadow-md transition-all shrink-0">
                Register Now →
            </a>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\edushopify\resources\views\welcome.blade.php ENDPATH**/ ?>