...
<?php $__env->startSection('body'); ?>
    ...
    <div class="max-w-5xl mx-auto space-y-6">
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('supplier.members.index')); ?>" class="text-xs font-semibold text-gray-600 hover:text-gray-900 px-3.5 py-2 bg-white border border-gray-300 rounded-xl">
        ...
        <form method="POST" action="<?php echo e(route('supplier.members.permissions.update', $member)); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="flex items-center justify-end gap-3 pt-4">
                <a href="<?php echo e(route('supplier.members.index')); ?>" class="px-5 py-2.5 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-xl hover:bg-gray-50">
                    Cancel
                </a>
...
<?php echo $__env->make('backend.layouts.supplier', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\supplier\organization\members\permissions.blade.php ENDPATH**/ ?>