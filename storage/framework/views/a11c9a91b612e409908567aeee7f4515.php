<?php $__env->startSection('title', 'Messages & Real-Time Chat'); ?>
<?php $__env->startSection('breadcrumb', 'Communication / Messages'); ?>

<?php $__env->startSection('body'); ?>
<script>
    window.chatInitialConfig = {
        currentUserId: <?php echo e($currentUser->id); ?>,
        currentAccountId: <?php echo e($currentAccount?->id ?? 'null'); ?>,
        activeConversationId: <?php echo e(isset($activeConversation) ? $activeConversation->id : 'null'); ?>,
        soundEnabled: <?php echo e(($userPreferences->sound_enabled ?? true) ? 'true' : 'false'); ?>,
        browserNotificationsEnabled: <?php echo e(($userPreferences->browser_notifications_enabled ?? false) ? 'true' : 'false'); ?>,
        reverbKey: '<?php echo e(config('broadcasting.connections.reverb.key') ?? env('REVERB_APP_KEY', '1m1w1dpziluc6nmp98gc')); ?>',
        reverbHost: '<?php echo e(config('broadcasting.connections.reverb.options.host') ?? env('REVERB_HOST', '127.0.0.1')); ?>',
        reverbPort: '<?php echo e(config('broadcasting.connections.reverb.options.port') ?? env('REVERB_PORT', 8080)); ?>',
        reverbScheme: '<?php echo e(config('broadcasting.connections.reverb.options.scheme') ?? env('REVERB_SCHEME', 'http')); ?>',
        initialConversations: <?php echo json_encode($initialConversations ?? [], 15, 512) ?>,
        initialMessages: <?php echo json_encode($initialMessages ?? [], 15, 512) ?>
    };
</script>
...
<?php echo $__env->make($layout ?? 'backend.layouts.buyer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\communication\messages\index.blade.php ENDPATH**/ ?>