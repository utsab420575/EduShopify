...
<div id="fn-mobile-menu" class="fixed top-0 left-0 h-full w-72 bg-white z-50 shadow-xl transform -translate-x-full transition-transform duration-200 lg:hidden flex flex-col">
  ...
  <div class="px-4 py-4 border-t border-gray-100 space-y-2">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
      <a href="<?php echo e(route('login', ['redirect' => url()->current()])); ?>" class="block text-center py-2.5 text-sm font-medium text-gray-700">Sign In</a>
      <a href="<?php echo e(route('register', ['redirect' => url()->current()])); ?>" class="block text-center bg-emerald-500 hover:bg-emerald-600 text-white text-sm font-semibold py-2.5 rounded-lg">Register</a>
    <?php else: ?>
