<?php $__env->startSection('title', 'How It Works — EduShopify'); ?>
<?php $__env->startSection('meta_description', 'Learn how EduShopify connects education buyers with verified suppliers through structured RFQ procurement.'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'frontend.components.navigation.breadcrumbs','data' => ['items' => ['How It Works' => null]]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['items' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['How It Works' => null])]); ?>
...
<?php endif; ?>
        ...
        <div x-show="track === 'buyer'" x-cloak class="space-y-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = [
                ...
                <div class="flex gap-4 fe-card rounded-2xl p-5">
                    <span class="w-9 h-9 rounded-full flex items-center justify-center font-semibold shrink-0" style="background:var(--fe-primary-soft);color:var(--fe-primary);"><?php echo e($i + 1); ?></span>
                    <div>
                        <p class="text-sm font-semibold" style="color:var(--fe-text);"><?php echo e($step['title']); ?></p>
                        <p class="text-sm mt-0.5" style="color:var(--fe-text-muted);"><?php echo e($step['text']); ?></p>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <div class="text-center pt-4">
                <a href="<?php echo e(route('frontend.handoff.post-rfq')); ?>" class="fe-btn-primary fe-focus-ring inline-block px-6 py-3 rounded-lg text-sm font-semibold">Post an RFQ</a>
            </div>
        </div>
        ...
        <div x-show="track === 'supplier'" x-cloak class="space-y-4">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            <div class="text-center pt-4">
                <a href="<?php echo e(route('register')); ?>" class="fe-btn-primary fe-focus-ring inline-block px-6 py-3 rounded-lg text-sm font-semibold">Become a Supplier</a>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\frontend\pages\how-it-works.blade.php ENDPATH**/ ?>