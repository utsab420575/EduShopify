...
<head>
    <meta charset="UTF-8">
    <title>Subscription Expiring — <?php echo e(config('app.name')); ?></title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>This is a friendly reminder that your <strong><?php echo e($subscription->plan->name); ?></strong> subscription is expiring soon.</p>

            <div class="alert-box">
                <h3>Expiry Date: <?php echo e($subscription->expires_at?->format('d M Y, H:i')); ?></h3>
            ...
            <center>
                <a href="<?php echo e(route('supplier.pricing')); ?>" class="btn">Renew My Subscription →</a>
            </center>
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\emails\subscription\expiring.blade.php ENDPATH**/ ?>