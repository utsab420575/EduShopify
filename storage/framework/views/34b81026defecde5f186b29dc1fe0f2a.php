...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['id', 'width' => 'max-w-3xl']));
...
foreach (array_filter((['id', 'width' => 'max-w-3xl']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div
    ...
    x-init="
        window.addEventListener('open-ajax-modal-<?php echo e($id); ?>', (e) => load(e.detail.url, e.detail.rowId, e.detail.queueKey, e.detail.showUrl));
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\components\backend\ajax-modal.blade.php ENDPATH**/ ?>