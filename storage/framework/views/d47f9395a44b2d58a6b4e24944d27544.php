...
<?php $__env->startSection('breadcrumb', 'Procurement Oversight / Purchase Orders / ' . $purchaseOrder->po_number); ?>

<?php $__env->startSection('body'); ?>

    <?php if (isset($component)) { $__componentOriginal6ccefb989a1afce853acb3cdbc40307e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6ccefb989a1afce853acb3cdbc40307e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-header','data' => ['title' => $purchaseOrder->po_number,'subtitle' => 'Purchase order details']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($purchaseOrder->po_number),'subtitle' => 'Purchase order details']); ?>
...
<?php $component->withAttributes(['title' => 'Order Summary']); ?>
                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                    <div><dt class="text-gray-500">Subtotal</dt><dd class="font-medium text-gray-900"><?php echo e(number_format($purchaseOrder->subtotal, 2)); ?></dd></div>
                    <div><dt class="text-gray-500">Tax</dt><dd class="font-medium text-gray-900"><?php echo e(number_format($purchaseOrder->tax_amount, 2)); ?></dd></div>
                    <div><dt class="text-gray-500">Shipping</dt><dd class="font-medium text-gray-900"><?php echo e(number_format($purchaseOrder->shipping_charge, 2)); ?></dd></div>
                    <div><dt class="text-gray-500">Grand Total</dt><dd class="font-semibold text-gray-900"><?php echo e(number_format($purchaseOrder->grand_total, 2)); ?> <?php echo e($purchaseOrder->currency_code); ?></dd></div>
                    <div><dt class="text-gray-500">Payment Status</dt><dd class="font-medium text-gray-900"><?php echo e(ucfirst($purchaseOrder->payment_status ?? '—')); ?></dd></div>
                    <div><dt class="text-gray-500">Issued</dt><dd class="font-medium text-gray-900"><?php echo e($purchaseOrder->issued_at?->format('d M Y') ?? '—'); ?></dd></div>
                </dl>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($purchaseOrder->items->isNotEmpty()): ?>
                <?php if (isset($component)) { $__componentOriginal3c6ebeac636fe1a833069360516dddbb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3c6ebeac636fe1a833069360516dddbb = $attributes; } ?>
                    ...
                    <ul class="space-y-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $purchaseOrder->statusHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $history): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="text-sm flex justify-between">
                                <span class="text-gray-700"><?php echo e(ucfirst($history->status ?? $history->to_status ?? '')); ?></span>
                                <span class="text-xs text-gray-400"><?php echo e($history->created_at->format('d M Y H:i')); ?></span>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </ul>
                 <?php echo $__env->renderComponent(); ?>
...
<?php $component->withAttributes(['title' => 'Parties']); ?>
                <dl class="space-y-3 text-sm">
                    <div><dt class="text-gray-500">Buyer</dt><dd class="font-medium text-gray-900"><a href="<?php echo e(route('admin.buyers.show', $purchaseOrder->buyerAccount)); ?>" class="hover:underline" style="color:var(--theme-primary)"><?php echo e($purchaseOrder->buyerAccount?->display_name); ?></a></dd></div>
                    <div><dt class="text-gray-500">Supplier</dt><dd class="font-medium text-gray-900"><a href="<?php echo e(route('admin.suppliers.show', $purchaseOrder->supplierAccount)); ?>" class="hover:underline" style="color:var(--theme-primary)"><?php echo e($purchaseOrder->supplierAccount?->supplierProfile?->display_name ?? $purchaseOrder->supplierAccount?->display_name); ?></a></dd></div>
                </dl>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3c6ebeac636fe1a833069360516dddbb)): ?>
...
<?php $component->withAttributes(['title' => 'Related Records']); ?>
                <div class="space-y-2 text-sm">
                    <a href="<?php echo e(route('admin.procurement.rfqs.show', $purchaseOrder->rfq)); ?>" class="block hover:underline" style="color:var(--theme-primary)">View RFQ &rarr;</a>
                    <a href="<?php echo e(route('admin.procurement.awards.show', $purchaseOrder->award)); ?>" class="block hover:underline" style="color:var(--theme-primary)">View Award &rarr;</a>
                </div>
             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal3c6ebeac636fe1a833069360516dddbb)): ?>
...
<?php echo $__env->make('backend.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\admin\procurement\purchase-orders\show.blade.php ENDPATH**/ ?>