    ...
    <div class="max-w-5xl mx-auto space-y-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Define a new custom role specifically for your institution members.</p>
            </div>
            <a href="<?php echo e(route('buyer.roles.index')); ?>" class="text-xs font-semibold text-gray-600 hover:text-gray-900 px-3.5 py-2 bg-white border border-gray-300 rounded-xl">
                &larr; Back to Roles
            </a>
        </div>
        ...
        <form method="POST" action="<?php echo e(route('buyer.roles.store')); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="display_name" value="<?php echo e(old('display_name')); ?>" required placeholder="e.g. Senior Procurement Officer" class="w-full px-4 py-2.5 rounded-xl border border-gray-300 text-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                    </div>
                    <div>
            ...
            <div class="flex items-center justify-end gap-3 pt-4">
                <a href="<?php echo e(route('buyer.roles.index')); ?>" class="px-5 py-2.5 text-sm font-semibold text-gray-700 bg-white border border-gray-300 rounded-xl hover:bg-gray-50">
                    Cancel
                </a>
...
<?php echo $__env->make('backend.layouts.buyer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\buyer\access-control\roles\create.blade.php ENDPATH**/ ?>