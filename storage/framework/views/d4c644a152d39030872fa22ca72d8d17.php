...
<div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($listing->supplierAccount): ?>
        ...
        <div class="px-4 py-4 space-y-3">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-600 flex items-center justify-center text-white font-extrabold text-sm shadow-sm flex-shrink-0">
                    <?php echo e(strtoupper(substr($profile?->display_name ?? $listing->supplierAccount->display_name, 0, 2))); ?>

                </div>
                <div class="min-w-0">
                    <p class="text-sm font-bold text-gray-900 truncate"><?php echo e($profile?->display_name ?? $listing->supplierAccount->display_name); ?></p>
                    <p class="text-[11px] text-gray-500 flex items-center gap-1">
                        <i class="fa-solid fa-location-dot text-gray-400 text-[10px]"></i>
                        <?php echo e($profile?->country?->name ?? 'International Supplier'); ?>
            ...
            <dl class="space-y-1.5 text-xs">
                <div class="flex justify-between items-center py-1 border-b border-gray-50">
                    ...
                    <dd class="font-mono font-semibold text-gray-700">#<?php echo e($listing->supplierAccount->id); ?></dd>
                </div>
                <div class="flex justify-between items-center py-1">
                    ...
                    <dd>
                        <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-emerald-50 text-emerald-700 border border-emerald-200">
                            <i class="fa-solid fa-circle text-[5px]"></i> <?php echo e(ucfirst($listing->supplierAccount->status ?? 'Active')); ?>
            ...
            <a href="<?php echo e(route('admin.suppliers.show', $listing->supplierAccount)); ?>"
...
<div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
    ...
    <dl class="divide-y divide-gray-50 text-xs">
        <div class="flex items-center justify-between px-4 py-2.5">
            ...
            <dd class="font-mono font-semibold text-gray-700"><?php echo e($listing->listing_number); ?></dd>
        </div>
        <div class="flex items-center justify-between px-4 py-2.5">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($listing->base_price): ?>
            <div class="flex items-center justify-between px-4 py-2.5">
                ...
                <dd class="font-bold text-indigo-700"><?php echo e($listing->currency_code); ?> <?php echo e(number_format($listing->base_price, 2)); ?></dd>
            </div>
        <?php else: ?>
            <div class="flex items-center justify-between px-4 py-2.5">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($listing->min_order_quantity): ?>
            <div class="flex items-center justify-between px-4 py-2.5">
                ...
                <dd class="font-semibold text-gray-700"><?php echo e(number_format($listing->min_order_quantity, 0)); ?> units</dd>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($listing->variants->isNotEmpty()): ?>
            <div class="flex items-center justify-between px-4 py-2.5">
                ...
                <dd class="font-semibold text-gray-700"><?php echo e($listing->variants->count()); ?> variant<?php echo e($listing->variants->count() !== 1 ? 's' : ''); ?></dd>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <div class="flex items-center justify-between px-4 py-2.5">
            <dt class="flex items-center gap-2 text-gray-500"><i class="fa-solid fa-images w-3 text-center text-gray-400"></i> Photos</dt>
            <dd class="font-semibold text-gray-700"><?php echo e($listing->getMedia('gallery')->count()); ?> uploaded</dd>
        </div>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($listing->approvedBy): ?>
            <div class="flex items-center justify-between px-4 py-2.5">
                ...
                <dd class="font-semibold text-gray-700"><?php echo e($listing->approvedBy->name); ?></dd>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($listing->rejection_reason && $listing->approval_status === 'rejected'): ?>
            <div class="px-4 py-3 bg-rose-50 border-t border-rose-100">
                ...
                <p class="text-xs text-rose-700 leading-relaxed"><?php echo e($listing->rejection_reason); ?></p>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </dl>
</div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $timelineSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stepIdx => $tStep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="flex gap-3 <?php echo e($stepIdx < $timelineTotal - 1 ? 'pb-4' : ''); ?> relative">
                    ...
                    <div class="flex-shrink-0 z-10 w-7 h-7 rounded-full flex items-center justify-center mt-0.5
                        <?php echo e($tStep['alert'] ? 'bg-rose-100' : ($tStep['done'] ? 'bg-indigo-100' : 'bg-gray-100')); ?>">
                        <i class="fa-solid <?php echo e($tStep['icon']); ?> text-[11px]
                            <?php echo e($tStep['alert'] ? 'text-rose-500' : ($tStep['done'] ? 'text-indigo-600' : 'text-gray-400')); ?>"></i>
                    </div>
                    <div class="flex-1 min-w-0 pt-1">
                        <p class="text-xs font-semibold <?php echo e($tStep['alert'] ? 'text-rose-600' : ($tStep['done'] ? 'text-gray-900' : 'text-gray-400')); ?>">
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\backend\admin\catalog\listings\partials\sidebar.blade.php ENDPATH**/ ?>