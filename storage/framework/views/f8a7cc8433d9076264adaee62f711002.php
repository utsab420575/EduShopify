<?php $__env->startSection('title', 'Edit Role: ' . $role->display_name); ?>
<?php $__env->startSection('breadcrumb', 'Access Control / Roles / Edit'); ?>
...
<?php $__env->startSection('body'); ?>
    ...
    <div class="max-w-5xl mx-auto space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Edit Role: <?php echo e($role->display_name); ?></h1>
                <p class="text-sm text-gray-500 mt-1">Update role details and customize permission privileges for your company.</p>
            </div>
        ...
        <form method="POST" action="<?php echo e(route('supplier.roles.update', $role)); ?>" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="display_name" value="<?php echo e(old('display_name', $role->display_name)); ?>" required class="w-full px-4 py-2.5 rounded-xl border border-gray-300 text-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-1">Description</label>
                        <input type="text" name="description" value="<?php echo e(old('description', $role->description)); ?>" class="w-full px-4 py-2.5 rounded-xl border border-gray-300 text-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                    </div>
                </div>
            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <label class="flex items-start gap-2.5 p-2.5 bg-white rounded-lg border border-gray-200 hover:border-indigo-300 hover:bg-indigo-50/20 cursor-pointer transition-colors">
                                        <input type="checkbox" name="permissions[]" value="<?php echo e($perm->name); ?>" <?php echo e($isChecked ? 'checked' : ''); ?> class="perm-checkbox w-4 h-4 mt-0.5 rounded text-indigo-600 focus:ring-indigo-500 border-gray-300">
                                        <div class="text-xs">
...
<?php echo $__env->make('backend.layouts.supplier', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\supplier\access-control\roles\edit.blade.php ENDPATH**/ ?>