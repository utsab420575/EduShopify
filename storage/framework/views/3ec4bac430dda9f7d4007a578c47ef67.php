...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($requiredDocsSatisfied): ?>
        ...
        <div class="px-5 py-4 overflow-y-auto space-y-5">
            <div>
                ...
                <dl class="grid grid-cols-2 gap-x-4 gap-y-2 text-xs">
                    ...
                    <div><dt class="text-gray-400">Organization</dt><dd class="font-semibold text-gray-800"><?php echo e($organization_name ?: '—'); ?></dd></div>
                    <div><dt class="text-gray-400">Website</dt><dd class="font-semibold text-gray-800"><?php echo e($website ?: '—'); ?></dd></div>
                    <div><dt class="text-gray-400">Locations</dt><dd class="font-semibold text-gray-800"><?php echo e(count($locations)); ?> location<?php echo e(count($locations) === 1 ? '' : 's'); ?></dd></div>
                </dl>
            </div>
            ...
            <div class="pt-4 border-t border-gray-100">
                ...
                <dl class="grid grid-cols-2 gap-x-4 gap-y-2 text-xs">
                    ...
                    <div><dt class="text-gray-400">Email</dt><dd class="font-semibold text-gray-800"><?php echo e($email ?: '—'); ?></dd></div>
                    <div><dt class="text-gray-400">Phone</dt><dd class="font-semibold text-gray-800"><?php echo e($phone ?: '—'); ?></dd></div>
                </dl>
            </div>
                ...
                <div class="flex items-center gap-3">
                    <div class="w-14 h-14 rounded-lg overflow-hidden border border-gray-200 bg-gray-50 flex items-center justify-center shrink-0">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile_photo): ?>
                            <img src="<?php echo e($profile_photo->temporaryUrl()); ?>" class="w-full h-full object-cover">
                        <?php elseif($existingProfilePhoto): ?>
                            <img src="<?php echo e(Storage::url($existingProfilePhoto)); ?>" class="w-full h-full object-cover">
                        <?php else: ?>
                    ...
                    <p class="text-xs text-gray-600"><?php echo e($existingGalleryImages->count() + count($gallery_files)); ?> gallery image<?php echo e(($existingGalleryImages->count() + count($gallery_files)) === 1 ? '' : 's'); ?></p>
                </div>
            </div>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH C:\laragon\www\edushopify\resources\views\livewire\buyer\partials\review-and-submit.blade.php ENDPATH**/ ?>