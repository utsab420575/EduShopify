...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['head' => null]));
...
foreach (array_filter((['head' => null]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($slot->isEmpty() || trim($slot->toHtml()) === ''): ?>
        <?php echo e($empty ?? ''); ?>
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\components\backend\table.blade.php ENDPATH**/ ?>