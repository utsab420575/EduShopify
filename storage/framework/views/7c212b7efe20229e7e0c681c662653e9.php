<?php $__env->startSection('title', 'Listing Types'); ?>
<?php $__env->startSection('breadcrumb', 'Catalog & Taxonomy / Listing Types'); ?>
...
<div x-data="{
    ...
    openCreate() {
        this.isEdit = false;
        this.formAction = '<?php echo e(route('admin.catalog.listing-types.store')); ?>';
        this.form = { id: null, name: '', code: '', description: '', sort_order: 0, is_active: true };
        this.modalOpen = true;
    },
    openEdit(item) {
        this.isEdit = true;
        this.formAction = '<?php echo e(url('admin/catalog/listing-types')); ?>/' + item.id;
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-header','data' => ['title' => 'Listing Types','subtitle' => 'Define the types of listings suppliers can create (e.g. Product, Service). Drives listing-specific form flows.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Listing Types','subtitle' => 'Define the types of listings suppliers can create (e.g. Product, Service). Drives listing-specific form flows.']); ?>
...
<?php endif; ?>
    ...
    <div class="mb-4">
        <form method="GET" action="<?php echo e(route('admin.catalog.listing-types.index')); ?>" class="flex flex-wrap items-center gap-3">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $status): ?>
                <a href="<?php echo e(route('admin.catalog.listing-types.index')); ?>" class="text-xs text-gray-500 hover:text-gray-800">Clear</a>
...
<?php $component->withAttributes([]); ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($listingTypes->isEmpty()): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.empty-state','data' => ['icon' => 'fa-boxes-stacked','title' => 'No listing types found']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-boxes-stacked','title' => 'No listing types found']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?> <?php $__env->endSlot(); ?>
        <?php else: ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $listingTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="hover:bg-gray-50/80 transition-colors">
                <td class="px-5 py-3.5 text-sm font-semibold text-gray-900">
                    <div class="flex items-center gap-2">
                        <span class="w-7 h-7 rounded-lg flex items-center justify-center text-xs"
                            ...
                            <i class="fa-solid <?php echo e($item->code === 'product' ? 'fa-box' : 'fa-screwdriver-wrench'); ?>"></i>
                        </span>
                ...
                <td class="px-5 py-3.5">
                    <span class="inline-flex items-center font-mono text-xs font-bold px-2 py-0.5 rounded bg-violet-50 text-violet-700 border border-violet-100"><?php echo e($item->code); ?></span>
                </td>
...
<?php endif; ?>
                ...
                <td class="px-5 py-3.5 text-right">
                    <div class="flex items-center justify-end gap-1.5">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('platform.attributes.manage')): ?>
                        <form method="POST" action="<?php echo e(route('admin.catalog.listing-types.toggle-active', $item)); ?>"
                              onsubmit="return confirmSwal(this, '<?php echo e($item->is_active ? 'Deactivate' : 'Activate'); ?> Listing Type?', '<?php echo e(addslashes($item->name)); ?> will be <?php echo e($item->is_active ? 'hidden from suppliers' : 'made available'); ?>.', 'question', 'Yes, <?php echo e($item->is_active ? 'Deactivate' : 'Activate'); ?>')">
                            <?php echo csrf_field(); ?>
                            <button type="submit"
                        ...
                        <form method="POST" action="<?php echo e(route('admin.catalog.listing-types.destroy', $item)); ?>"
                              onsubmit="return confirmSwal(this, 'Delete Listing Type?', 'Delete <?php echo e(addslashes($item->name)); ?>? This cannot be undone.', 'warning', 'Yes, Delete')">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.pagination','data' => ['paginator' => $listingTypes]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['paginator' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($listingTypes)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('backend.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\admin\catalog\listing-types\index.blade.php ENDPATH**/ ?>