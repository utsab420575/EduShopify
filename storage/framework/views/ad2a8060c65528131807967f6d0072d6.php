...
<?php $__env->startSection('body'); ?>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1"><?php echo e($role->description ?: 'Role permissions and member assignments for this organization.'); ?></p>
        </div>

        <div class="flex items-center gap-2">
            <form method="POST" action="<?php echo e(route('supplier.roles.duplicate', $role)); ?>" onsubmit="const name = prompt('Name for the duplicated role:', '<?php echo e(addslashes($role->display_name ?: $role->name)); ?> (Copy)'); if (name) { this.querySelector('input[name=new_display_name]').value = name; return true; } return false;">
                <?php echo csrf_field(); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$role->is_system && $role->account_id === $account->id): ?>
                <a href="<?php echo e(route('supplier.roles.edit', $role)); ?>" class="px-3.5 py-2 text-xs font-semibold text-white bg-blue-600 rounded-xl hover:bg-blue-700 flex items-center gap-1.5">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div class="flex items-center justify-between py-3">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($assigned): ?>
                                <form method="POST" action="<?php echo e(route('supplier.roles.unassign', $role)); ?>">
                                    <?php echo csrf_field(); ?>
                            ...
                            <?php else: ?>
                                <form method="POST" action="<?php echo e(route('supplier.roles.assign', $role)); ?>">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="member_id" value="<?php echo e($m->id); ?>">
...
<?php echo $__env->make('backend.layouts.supplier', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\supplier\access-control\roles\show.blade.php ENDPATH**/ ?>