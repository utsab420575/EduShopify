        ...
        <?php else: ?>
          ...
          <div class="mb-10 p-6 bg-gradient-to-br from-emerald-50/60 via-gray-50 to-blue-50/40 rounded-2xl border border-emerald-100/90 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2.5 shrink-0 w-full sm:w-auto justify-end">
              <a href="<?php echo e(route('login')); ?>" class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl transition-all shadow-xs text-center">
                Sign In to Comment
              </a>
              <a href="<?php echo e(route('register')); ?>" class="px-4 py-2.5 bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 text-xs font-bold rounded-xl transition-all text-center">
                Register
              </a>
            </div>
          </div>
              ...
              <div id="reply-box-<?php echo e($comment->id); ?>" class="hidden mt-4 pl-6 sm:pl-10">
                ...
                <?php else: ?>
                  <div class="p-3 bg-white rounded-xl border border-gray-200 text-xs text-gray-500 flex items-center justify-between">
                    <span>Please <a href="<?php echo e(route('login')); ?>" class="text-emerald-600 font-bold hover:underline">sign in</a> to reply to this comment.</span>
