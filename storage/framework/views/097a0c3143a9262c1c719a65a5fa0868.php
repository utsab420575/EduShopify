...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-header','data' => ['title' => 'Roles','subtitle' => 'Global roles available across the platform. Configure default permissions and assign roles.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Roles','subtitle' => 'Global roles available across the platform. Configure default permissions and assign roles.']); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('admin.access-control.roles.create')); ?>" class="btn-primary text-sm font-medium px-4 py-2 rounded-lg"><i class="fa-solid fa-plus mr-1.5"></i>New Role</a>
         <?php $__env->endSlot(); ?>
         ...
         <?php $__env->slot('toolbar', null, []); ?> 
            <form method="GET" class="flex flex-wrap items-center gap-2 w-full">
                <div class="relative flex-1 min-w-[200px]">
                    ...
                    <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Search roles..." class="focus-accent w-full pl-9 pr-3 py-2 text-sm rounded-lg border border-gray-300">
                </div>
                <select name="scope" onchange="this.form.submit()" class="focus-accent text-sm rounded-lg border border-gray-300 px-3 py-2 bg-white">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['platform' => 'Platform Staff', 'buyer' => 'Buyer', 'supplier' => 'Supplier', 'common' => 'Common', 'both' => 'Both (Supplier & Buyer)']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value); ?>" <?php if($scope === $value): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.empty-state','data' => ['icon' => 'fa-user-shield','title' => 'No roles found']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-user-shield','title' => 'No roles found']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-5 py-3.5">
                        <p class="text-sm font-semibold text-gray-900"><?php echo e($role->display_name ?? $role->name); ?></p>
                    ...
                    <td class="px-5 py-3.5 text-sm text-gray-600 capitalize">
                        <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium 
                            <?php echo e($role->capability_scope === 'supplier' ? 'bg-emerald-50 text-emerald-700' : ($role->capability_scope === 'buyer' ? 'bg-amber-50 text-amber-700' : 'bg-blue-50 text-blue-700')); ?>">
                            <?php echo e($role->capability_scope); ?>
                    ...
                    <td class="px-5 py-3.5 text-sm text-gray-600"><?php echo e($role->users_count); ?></td>
                    <td class="px-5 py-3.5">
                    ...
                    <td class="px-5 py-3.5 text-right">
                        <div class="flex items-center justify-end gap-1.5">
                            ...
                            <form method="POST" action="<?php echo e(route('admin.access-control.roles.duplicate', $role)); ?>" onsubmit="const name = prompt('Name for duplicated role:', '<?php echo e(addslashes($role->display_name ?? $role->name)); ?> (Copy)'); if (name) { this.querySelector('input[name=new_display_name]').value = name; return true; } return false;">
                                <?php echo csrf_field(); ?>
                            ...
                            <a href="<?php echo e(route('admin.access-control.roles.edit', $role)); ?>" title="Edit Role & Permissions" class="w-8 h-8 rounded-lg inline-flex items-center justify-center text-indigo-600 hover:bg-indigo-50">
                                <i class="fa-regular fa-pen-to-square"></i>
                            </a>

                            <!-- Delete Role -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isCoreRoot && $role->users_count === 0): ?>
                                <form method="POST" action="<?php echo e(route('admin.access-control.roles.destroy', $role)); ?>" onsubmit="return confirm('Are you sure you want to delete role <?php echo e(addslashes($role->display_name ?? $role->name)); ?>?');">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.pagination','data' => ['paginator' => $roles]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('backend.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\admin\access-control\roles\index.blade.php ENDPATH**/ ?>