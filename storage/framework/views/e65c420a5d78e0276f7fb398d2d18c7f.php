...
<?php $__env->startSection('breadcrumb', 'Communication / Contact Inquiries'); ?>

<?php $__env->startSection('body'); ?>

    <?php if (isset($component)) { $__componentOriginal6ccefb989a1afce853acb3cdbc40307e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6ccefb989a1afce853acb3cdbc40307e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-header','data' => ['title' => 'Contact Inquiries','subtitle' => 'Inbound enquiries from buyers and visitors who contacted you through your public profile.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Contact Inquiries','subtitle' => 'Inbound enquiries from buyers and visitors who contacted you through your public profile.']); ?>
...
<?php endif; ?>
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4 mb-6">
        <form method="GET" action="<?php echo e(route('supplier.contact-inquiries.index')); ?>" class="flex flex-wrap items-center gap-3">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status): ?>
                <a href="<?php echo e(route('supplier.contact-inquiries.index')); ?>" class="text-xs text-gray-500 hover:text-gray-700">Reset</a>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.empty-state','data' => ['icon' => 'fa-envelope-open-text','title' => 'No inquiries found','description' => 'Inbound contact messages from your public supplier profile will appear here.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-envelope-open-text','title' => 'No inquiries found','description' => 'Inbound contact messages from your public supplier profile will appear here.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $inquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 <?php echo e($inquiry->status === 'new' ? 'font-semibold' : ''); ?>">
                                <td class="px-5 py-3.5 text-xs font-mono text-gray-500"><?php echo e($inquiry->inquiry_number); ?></td>
                                <td class="px-3 py-3.5">
                                    <p class="text-sm font-medium text-gray-900"><?php echo e($inquiry->name); ?></p>
                                    <p class="text-xs text-gray-400"><?php echo e($inquiry->organization); ?></p>
                                </td>
                                <td class="px-3 py-3.5 text-sm text-gray-700 max-w-xs truncate"><?php echo e($inquiry->subject); ?></td>
                                <td class="px-3 py-3.5 text-xs text-gray-500">
                                    <?php echo e($inquiry->listing?->title ?? '—'); ?>

                                </td>
                                <td class="px-3 py-3.5 text-xs text-gray-400"><?php echo e($inquiry->created_at->format('d M Y')); ?></td>
                                <td class="px-3 py-3.5">
...
<?php endif; ?>
                                ...
                                <td class="px-5 py-3.5 text-right">
                                    <a href="<?php echo e(route('supplier.contact-inquiries.show', $inquiry)); ?>"
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($inquiries->hasPages()): ?>
...
<?php echo $__env->make('backend.layouts.supplier', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\supplier\communication\inquiries\index.blade.php ENDPATH**/ ?>