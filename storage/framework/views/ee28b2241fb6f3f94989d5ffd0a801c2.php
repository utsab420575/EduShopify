...
<?php $__env->startSection('breadcrumb', 'System & Settings / Currencies'); ?>

<?php $__env->startSection('body'); ?>

    <?php if (isset($component)) { $__componentOriginal6ccefb989a1afce853acb3cdbc40307e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6ccefb989a1afce853acb3cdbc40307e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-header','data' => ['title' => 'Currencies','subtitle' => 'Currencies supported for pricing across the platform.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Currencies','subtitle' => 'Currencies supported for pricing across the platform.']); ?>
         <?php $__env->slot('actions', null, []); ?> 
            <a href="<?php echo e(route('admin.system.currencies.create')); ?>" class="btn-primary text-sm font-medium px-4 py-2 rounded-lg"><i class="fa-solid fa-plus mr-1.5"></i>New Currency</a>
         <?php $__env->endSlot(); ?>
        ...
        <?php else: ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="hover:bg-gray-50">
                    <td class="px-5 py-3.5 text-sm font-medium text-gray-900"><?php echo e($currency->code); ?> &mdash; <?php echo e($currency->name); ?></td>
                    <td class="px-5 py-3.5 text-sm text-gray-600"><?php echo e($currency->symbol); ?></td>
                    <td class="px-5 py-3.5 text-sm text-gray-600"><?php echo e($currency->exchange_rate); ?></td>
                    <td class="px-5 py-3.5 text-sm text-gray-600">
                        ...
                        <?php else: ?>
                            <form method="POST" action="<?php echo e(route('admin.system.currencies.default', $currency)); ?>">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?></td>
                    <td class="px-5 py-3.5 text-right">
                        <div class="flex items-center justify-end gap-1.5">
                            <a href="<?php echo e(route('admin.system.currencies.edit', $currency)); ?>" class="w-8 h-8 rounded-lg inline-flex items-center justify-center text-gray-500 hover:bg-gray-100"><i class="fa-regular fa-pen-to-square"></i></a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$currency->is_default): ?>
                                <form method="POST" action="<?php echo e(route('admin.system.currencies.destroy', $currency)); ?>" onsubmit="return confirm('Delete this currency?');">
...
<?php echo $__env->make('backend.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\admin\system\currencies\index.blade.php ENDPATH**/ ?>