<?php $__env->startSection('title', $post->meta_title ?? $post->title . ' – Edushopify Blog'); ?>
...
<div class="bg-white border-b border-gray-200">
  <div class="max-w-7xl mx-auto px-4 py-3 text-xs text-gray-500 flex items-center gap-2 overflow-x-auto whitespace-nowrap">
    <a href="<?php echo e(route('v2.home')); ?>" class="hover:text-emerald-600 transition-colors">Home</a>
    <span>/</span>
    <a href="<?php echo e(route('v2.blogs.index')); ?>" class="hover:text-emerald-600 transition-colors">Blog</a>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->category): ?>
      <span>/</span>
      <a href="<?php echo e(route('v2.blogs.index', ['category' => $post->category->slug])); ?>" class="hover:text-emerald-600 transition-colors">
        <?php echo e($post->category->name); ?>

      </a>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <span>/</span>
    <span class="text-gray-900 font-medium truncate max-w-xs"><?php echo e($post->title); ?></span>
  </div>
</div>
    ...
    <main class="w-full lg:w-2/3 xl:w-3/4">
      <article class="bg-white rounded-3xl border border-gray-200/90 shadow-sm overflow-hidden p-6 sm:p-10">
        ...
        <div class="flex flex-wrap items-center gap-3 mb-4">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->category): ?>
            <a href="<?php echo e(route('v2.blogs.index', ['category' => $post->category->slug])); ?>"
          ...
          <span class="text-xs text-gray-500"><?php echo e($post->published_at?->format('F d, Y')); ?></span>
          <span class="text-xs text-gray-400">•</span>
          <span class="text-xs text-gray-500 flex items-center gap-1">
            <svg class="w-3.5 h-3.5 text-gray-400" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
              <circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>
            </svg>
            <?php echo e($post->reading_time_minutes ?? 5); ?> min read
          </span>
        </div>
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 py-4 border-y border-gray-100 mb-8">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 rounded-full bg-emerald-100 text-emerald-700 flex items-center justify-center font-bold text-sm">
              <?php echo e($authorInitial); ?>

            </div>
            <div>
              <p class="text-sm font-semibold text-gray-900"><?php echo e($authorName); ?></p>
          ...
          <div class="flex items-center gap-2 sm:gap-3 text-xs">
            ...
            <a href="#comments-section" class="flex items-center gap-1.5 text-gray-500 bg-gray-50 hover:bg-emerald-50 hover:text-emerald-700 px-3 py-1.5 rounded-full border border-gray-100 transition-colors" title="Jump to Comments">
              ...
              <span class="post-comments-count-label"><?php echo e($post->comments_count); ?></span>
            </a>
            ...
            <button type="button"
                    ...
                    id="top-like-btn"
                    class="post-like-trigger flex items-center gap-1.5 px-3 py-1.5 rounded-full border transition-all cursor-pointer font-semibold <?php echo e($hasLikedPost ? 'bg-rose-50 border-rose-200 text-rose-600 shadow-sm' : 'bg-gray-50 border-gray-200 text-gray-600 hover:bg-rose-50 hover:border-rose-200 hover:text-rose-600'); ?>"
                    title="<?php echo e($hasLikedPost ? 'Unlike article' : 'Like article'); ?>">
              <svg class="post-like-icon w-4 h-4 transition-transform <?php echo e($hasLikedPost ? 'text-rose-500' : 'text-gray-400'); ?>" fill="<?php echo e($hasLikedPost ? 'currentColor' : 'none'); ?>" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg>
              <span class="post-likes-count-label"><?php echo e($post->likes_count); ?></span>
        ...
        <div class="rounded-2xl overflow-hidden mb-8 shadow-sm">
          <img src="<?php echo e($cover); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-auto max-h-[460px] object-cover" />
        </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->images->isNotEmpty()): ?>
          <div class="mt-10 pt-8 border-t border-gray-100">
            <h3 class="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4">Article Gallery</h3>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $post->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $img): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="rounded-xl overflow-hidden border border-gray-100 bg-gray-50">
                  <img src="<?php echo e($img->url()); ?>" alt="<?php echo e($img->caption ?? 'Gallery Image'); ?>" class="w-full h-48 object-cover" />
                  <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($img->caption): ?>
                    <p class="p-2.5 text-xs text-gray-500 italic bg-white"><?php echo e($img->caption); ?></p>
                  <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
        ...
        <div class="mt-10 p-5 sm:p-6 bg-gradient-to-r from-emerald-50/90 via-teal-50/50 to-gray-50 rounded-2xl border border-emerald-100 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div class="flex items-center gap-3 flex-wrap">
            ...
            <button type="button"
                    onclick="handleTogglePostLike()"
                    id="banner-like-btn"
                    class="post-like-trigger flex items-center gap-2 px-5 py-2.5 rounded-xl font-bold text-sm transition-all shadow-sm cursor-pointer <?php echo e($hasLikedPost ? 'bg-rose-500 text-white shadow-rose-200 hover:bg-rose-600' : 'bg-white text-gray-700 border border-gray-200 hover:border-rose-300 hover:text-rose-600 hover:bg-rose-50/50'); ?>">
              <svg class="post-like-icon w-5 h-5 transition-transform <?php echo e($hasLikedPost ? 'text-white' : 'text-gray-400'); ?>" fill="<?php echo e($hasLikedPost ? 'currentColor' : 'none'); ?>" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
              </svg>
              <span class="post-like-text"><?php echo e($hasLikedPost ? 'Liked' : 'Like Article'); ?></span>
              <span class="post-likes-count-label <?php echo e($hasLikedPost ? 'bg-white/20 text-white' : 'bg-gray-100 text-gray-700'); ?> px-2 py-0.5 rounded-full text-xs font-bold"><?php echo e($post->likes_count); ?></span>
            </button>
            ...
            <a href="#comments-section"
              ...
              <span class="post-comments-count-label bg-gray-100 text-gray-600 px-2 py-0.5 rounded-full text-xs font-bold"><?php echo e($post->comments_count); ?></span>
            </a>
          </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->tags->isNotEmpty()): ?>
          <div class="mt-8 pt-6 border-t border-gray-100 flex flex-wrap items-center gap-2">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $post->tags; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <a href="<?php echo e(route('v2.blogs.index', ['tag' => $tag->slug])); ?>"
      ...
      <section id="comments-section" class="mt-10 bg-white rounded-3xl border border-gray-200/90 shadow-sm p-6 sm:p-10 scroll-mt-6">
            ...
            <div class="flex items-center justify-between mb-3">
              <div class="flex items-center gap-2.5">
                <div class="w-8 h-8 rounded-full bg-emerald-600 text-white font-bold text-xs flex items-center justify-center shrink-0 shadow-xs">
                  <?php echo e($currentAuthorInitial); ?>

                </div>
                <div>
                  <span class="text-xs font-bold text-gray-900"><?php echo e($currentAuthorName); ?></span>
        ...
        <?php else: ?>
          ...
          <div class="mb-10 p-6 bg-gradient-to-br from-emerald-50/60 via-gray-50 to-blue-50/40 rounded-2xl border border-emerald-100/90 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-2.5 shrink-0 w-full sm:w-auto justify-end">
              <a href="<?php echo e(route('login', ['redirect' => url()->current()])); ?>" class="px-5 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl transition-all shadow-xs text-center">
                Sign In to Comment
              </a>
              <a href="<?php echo e(route('register', ['redirect' => url()->current()])); ?>" class="px-4 py-2.5 bg-white hover:bg-gray-50 text-gray-700 border border-gray-200 text-xs font-bold rounded-xl transition-all text-center">
                Register
              </a>
            </div>
          </div>
        ...
        <div id="comments-container" class="space-y-6">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $post->approvedComments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            <div id="comment-card-<?php echo e($comment->id); ?>" class="p-5 rounded-2xl bg-gray-50/80 border border-gray-100 hover:border-gray-200 transition-all">
              
              <div class="flex items-start justify-between gap-3 mb-2">
                <div class="flex items-center gap-2.5">
                  <div class="w-8 h-8 rounded-full bg-emerald-600 text-white font-bold text-xs flex items-center justify-center shrink-0 shadow-xs">
                    <?php echo e(strtoupper(substr($commenterName, 0, 1))); ?>

                  </div>
                  <div>
                    <div class="flex items-center gap-1.5 flex-wrap">
                      <p class="text-xs font-bold text-gray-900"><?php echo e($commenterName); ?></p>
                      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($comment->account_id === $post->account_id): ?>
                        <span class="text-[10px] font-bold px-1.5 py-0.2 rounded bg-emerald-100 text-emerald-800">Author</span>
                      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <p class="text-[10px] text-gray-400"><?php echo e($comment->created_at->diffForHumans()); ?></p>
                  </div>
                </div>

                
                <button type="button"
                        onclick="handleToggleCommentLike(<?php echo e($comment->id); ?>, this)"
                        data-comment-id="<?php echo e($comment->id); ?>"
                        class="comment-like-btn flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-lg border transition-all cursor-pointer <?php echo e($isCommentLiked ? 'bg-rose-50 border-rose-200 text-rose-600' : 'bg-white border-gray-200 text-gray-600 hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200'); ?>"
                        title="<?php echo e($isCommentLiked ? 'Unlike comment' : 'Like comment'); ?>">
                  <svg class="w-3.5 h-3.5 <?php echo e($isCommentLiked ? 'text-rose-500' : 'text-gray-400'); ?>" fill="<?php echo e($isCommentLiked ? 'currentColor' : 'none'); ?>" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                  </svg>
                  <span class="comment-likes-count"><?php echo e($comment->likes_count); ?></span>
                </button>
              </div>
              ...
              <div class="mt-3 pl-10 flex items-center gap-4">
                <button type="button"
                        onclick="toggleReplyBox(<?php echo e($comment->id); ?>)"
              ...
              <div id="reply-box-<?php echo e($comment->id); ?>" class="hidden mt-4 pl-6 sm:pl-10">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                  <form onsubmit="handleReplySubmit(event, <?php echo e($comment->id); ?>)" class="p-3.5 bg-white rounded-xl border border-gray-200 space-y-2.5 shadow-xs">
                    <?php echo csrf_field(); ?>
                    <div class="flex items-center justify-between text-[11px] text-gray-500">
                      <span>Replying to <strong class="text-gray-800"><?php echo e($commenterName); ?></strong></span>
                      <button type="button" onclick="toggleReplyBox(<?php echo e($comment->id); ?>)" class="text-gray-400 hover:text-gray-600 cursor-pointer">✕ Cancel</button>
                    </div>
                    <textarea id="reply-input-<?php echo e($comment->id); ?>"
                              rows="2"
                              required
                              minlength="3"
                              maxlength="2000"
                    ...
                    <div class="flex justify-end gap-2">
                      <button type="button" onclick="toggleReplyBox(<?php echo e($comment->id); ?>)" class="px-3 py-1 text-xs text-gray-500 hover:text-gray-700 rounded-lg cursor-pointer">Cancel</button>
                ...
                <?php else: ?>
                  <div class="p-3 bg-white rounded-xl border border-gray-200 text-xs text-gray-500 flex items-center justify-between">
                    <span>Please <a href="<?php echo e(route('login', ['redirect' => url()->current()])); ?>" class="text-emerald-600 font-bold hover:underline">sign in</a> to reply to this comment.</span>
                    <button type="button" onclick="toggleReplyBox(<?php echo e($comment->id); ?>)" class="text-gray-400 hover:text-gray-600 cursor-pointer">✕</button>
                  </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
              </div>

              
              <div id="replies-list-<?php echo e($comment->id); ?>" class="mt-4 pl-6 sm:pl-10 space-y-3 border-l-2 border-emerald-100 <?php echo e($comment->approvedReplies->isEmpty() ? 'hidden' : ''); ?>">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $comment->approvedReplies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reply): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <?php
                  ...
                  ?>
                  <div id="reply-card-<?php echo e($reply->id); ?>" class="p-3 bg-white rounded-xl border border-gray-200/80 hover:border-gray-300 transition-all">
                    <div class="flex items-start justify-between gap-2 mb-1.5">
                      <div class="flex items-center gap-2">
                        <div class="w-6 h-6 rounded-full bg-blue-100 text-blue-700 font-bold text-[10px] flex items-center justify-center shrink-0">
                          <?php echo e(strtoupper(substr($replyAuthor, 0, 1))); ?>

                        </div>
                        <div class="flex items-center gap-1.5 flex-wrap">
                          <span class="text-xs font-bold text-gray-900"><?php echo e($replyAuthor); ?></span>
                          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($reply->account_id === $post->account_id): ?>
                      ...
                      <button type="button"
                              onclick="handleToggleCommentLike(<?php echo e($reply->id); ?>, this)"
                              data-comment-id="<?php echo e($reply->id); ?>"
                              class="comment-like-btn flex items-center gap-1 text-[11px] font-semibold px-2 py-0.5 rounded border transition-all cursor-pointer <?php echo e($isReplyLiked ? 'bg-rose-50 border-rose-200 text-rose-600' : 'bg-gray-50 border-gray-200 text-gray-500 hover:bg-rose-50 hover:text-rose-600 hover:border-rose-200'); ?>"
                              title="<?php echo e($isReplyLiked ? 'Unlike reply' : 'Like reply'); ?>">
                        <svg class="w-3 h-3 <?php echo e($isReplyLiked ? 'text-rose-500' : 'text-gray-400'); ?>" fill="<?php echo e($isReplyLiked ? 'currentColor' : 'none'); ?>" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                          <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                        </svg>
                        <span class="comment-likes-count"><?php echo e($reply->likes_count); ?></span>
                      </button>
                    </div>
    ...
    <aside class="w-full lg:w-1/3 xl:w-1/4 flex flex-col gap-6">
      ...
      <div class="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <div class="flex items-center gap-3 mb-3">
          ...
          <div class="min-w-0">
            <h4 class="text-sm font-bold text-gray-900 truncate"><?php echo e($authorName); ?></h4>
        ...
        <a href="<?php echo e(route('v2.blogs.index')); ?>" class="block text-center text-xs font-semibold text-emerald-600 hover:text-emerald-700 hover:underline">
      ...
      <div class="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <ul class="space-y-2 text-sm">
          <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $allCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li>
              <a href="<?php echo e(route('v2.blogs.index', ['category' => $cat->slug])); ?>"
                 class="flex items-center justify-between py-1.5 px-2 rounded-lg text-gray-700 hover:bg-emerald-50 hover:text-emerald-700 transition-colors <?php echo e($post->category_id == $cat->id ? 'font-bold text-emerald-700 bg-emerald-50/70' : ''); ?>">
                <span><?php echo e($cat->name); ?></span>
                <span class="text-xs bg-gray-100 text-gray-500 px-2 py-0.5 rounded-full font-medium"><?php echo e($cat->posts_count); ?></span>
              </a>
            </li>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </ul>
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($relatedPosts->isNotEmpty()): ?>
        <div class="bg-white rounded-2xl border border-gray-200 p-6">
          ...
          <div class="space-y-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $relatedPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <?php
                $relCover = $rel->coverImageUrl();
              ?>
              <a href="<?php echo e(route('v2.blogs.show', $rel->slug)); ?>" class="group flex gap-3 items-center">
                <img src="<?php echo e($relCover); ?>" alt="<?php echo e($rel->title); ?>" class="w-16 h-16 rounded-xl object-cover shrink-0 group-hover:scale-105 transition-transform" />
                <div class="min-w-0 flex-1">
                  ...
                  <p class="text-[10px] text-gray-400 mt-1"><?php echo e($rel->published_at?->format('M d, Y')); ?></p>
                </div>
              </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
          </div>
...
<script>
  ...
  const POST_LIKE_URL = "<?php echo e(route('v2.blogs.like', $post->slug)); ?>";
  const POST_COMMENT_URL = "<?php echo e(route('v2.blogs.comment', $post->slug)); ?>";
  const COMMENT_LIKE_BASE_URL = "<?php echo e(url('v2/blog/comment')); ?>";
  const LOGIN_URL = "<?php echo e(route('login', ['redirect' => url()->current()])); ?>";
  const IS_LOGGED_IN = <?php echo e(auth()->check() ? 'true' : 'false'); ?>;
...
<?php echo $__env->make('frontend_new.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views/frontend_new/blogs/show.blade.php ENDPATH**/ ?>