...
<head>
    ...
    <title><?php echo e($title ?? config('app.name')); ?> — Edushopify</title>
...
<body class="bg-gray-50 min-h-screen flex items-center justify-center py-12 px-4">
    ...
    <div class="relative z-10 w-full <?php echo e($maxWidth ?? 'max-w-lg'); ?>">

        <!-- Logo -->
        <div class="text-center mb-8">
            <a href="<?php echo e(url('/')); ?>" class="inline-flex items-center justify-center">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Edushopify" class="h-12 w-auto object-contain">
            </a>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($subtitle)): ?>
                <p class="text-gray-500 mt-2 text-sm"><?php echo e($subtitle); ?></p>
        ...
        <div class="text-center mt-6 text-gray-500 text-sm space-x-4">
            <a href="<?php echo e(url('/')); ?>" class="hover:text-gray-900 transition">Home</a>
            <span>·</span>
            <a href="<?php echo e(route('login')); ?>" class="hover:text-gray-900 transition">Sign In</a>
            <span>·</span>
            <span>© <?php echo e(date('Y')); ?> Edushopify</span>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\components\layouts\auth.blade.php ENDPATH**/ ?>