...
<div id="sp-section-media" class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden" x-data="{ open: <?php echo e($spAccOpen('media', false)); ?> }" x-init="$watch('open', v => localStorage.setItem('sp-acc-media', v ? '1' : '0'))">
    ...
    <div x-show="open" x-cloak x-transition class="border-t border-gray-100 px-6 py-6">
        <form method="POST" action="<?php echo e(route('supplier.company.profile.media.update')); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>

            <?php echo $__env->make('backend.supplier.company.partials._section-errors', ['section' => 'media'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <img id="logo-preview" src="<?php echo e($profile?->logo ? asset('storage/'.$profile->logo) : 'https://ui-avatars.com/api/?name='.urlencode($profile?->display_name ?? 'S').'&background=e0e7ff&color=4f46e5'); ?>"
                ...
                <div>
                    ...
                    <div class="flex items-center gap-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($profile?->profile_photo): ?>
                            <img id="photo-preview" src="<?php echo e(asset('storage/'.$profile->profile_photo)); ?>" class="w-16 h-16 rounded-full object-cover border border-gray-200" alt="Photo">
                        <?php else: ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <img id="banner-preview" src="<?php echo e($profile?->banner ? asset('storage/'.$profile->banner) : ''); ?>" class="w-full h-24 rounded-lg object-cover bg-gray-100 mb-3" style="<?php echo e($profile?->banner ? '' : 'display:none'); ?>" alt="Banner">
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\backend\supplier\company\partials\_media.blade.php ENDPATH**/ ?>