...
<?php $__env->startSection('breadcrumb', 'Reviews'); ?>

<?php $__env->startSection('body'); ?>

    <?php if (isset($component)) { $__componentOriginal6ccefb989a1afce853acb3cdbc40307e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6ccefb989a1afce853acb3cdbc40307e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-header','data' => ['title' => 'My Reviews','subtitle' => 'Reviews you\'ve written for suppliers and products.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'My Reviews','subtitle' => 'Reviews you\'ve written for suppliers and products.']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.empty-state','data' => ['icon' => 'fa-star','title' => 'No reviews yet','description' => 'After a quotation experience or completed purchase, you can leave a review from that page.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-star','title' => 'No reviews yet','description' => 'After a quotation experience or completed purchase, you can leave a review from that page.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component->withAttributes([]); ?>
                    <div class="flex items-start justify-between gap-3">
                        <div class="min-w-0">
                            <p class="text-[11px] font-semibold uppercase tracking-wide <?php echo e($review->review_type === 'product' ? 'text-purple-600' : 'text-indigo-600'); ?>">
                                <?php echo e($review->review_type === 'product' ? 'Product' : 'Supplier'); ?>

                            </p>
                            <p class="text-sm font-medium text-gray-900 mt-0.5">
                                <?php echo e($review->review_type === 'product' ? ($review->listing?->name ?? 'Product') : $review->supplierAccount?->supplierProfile?->display_name); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($review->title): ?>
                                <p class="text-sm font-semibold text-gray-800 mt-2"><?php echo e($review->title); ?></p>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($review->reply): ?>
                                <div class="mt-3 pl-3 border-l-2 border-gray-100">
                                    ...
                                    <p class="text-sm text-gray-600 mt-0.5"><?php echo e($review->reply->reply); ?></p>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
...
<?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($review->review_type === 'product'): ?>
                                <button @click="$dispatch('open-modal-edit-review-<?php echo e($review->id); ?>')" class="text-xs font-medium hover:underline" style="color:var(--theme-primary)">Edit</button>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                 <?php echo $__env->renderComponent(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.modal','data' => ['id' => 'edit-review-'.e($review->id).'','title' => 'Edit Product Review']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'edit-review-'.e($review->id).'','title' => 'Edit Product Review']); ?>
                        <form method="POST" action="<?php echo e(route('buyer.reviews.update-product', $review)); ?>" x-data="{ rating: <?php echo e($review->rating); ?> }">
                            <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.input','data' => ['name' => 'title','label' => 'Title (optional)','value' => $review->title]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'title','label' => 'Title (optional)','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($review->title)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.textarea','data' => ['name' => 'comment','label' => 'Comment (optional)','value' => $review->comment]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'comment','label' => 'Comment (optional)','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($review->comment)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('backend.layouts.buyer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\buyer\reviews\index.blade.php ENDPATH**/ ?>