...
<head>
    ...
    <title>Subscription Active — <?php echo e(config('app.name')); ?></title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Welcome to <?php echo e($subscription->plan->name); ?></p>
        </div>

        <div class="body">
            <p>Hi <strong><?php echo e($subscription->supplierAccount?->display_name); ?></strong>,</p>
            <p>Your subscription has been successfully activated. Here's a summary:</p>

            <div class="plan-card">
                <h3><?php echo e($subscription->plan->name); ?></h3>
                <p><?php echo e(ucfirst($subscription->plan->billing_type)); ?> Plan</p>
            </div>

            <div class="detail-row">
                <span class="detail-label">Start Date</span>
                <span class="detail-value"><?php echo e($subscription->starts_at?->format('d M Y')); ?></span>
            </div>
            <div class="detail-row">
                <span class="detail-label">Expires</span>
                <span class="detail-value">
                    <?php echo e($subscription->expires_at ? $subscription->expires_at->format('d M Y') : 'Never'); ?>
            ...
            <div class="detail-row">
                ...
                <span class="detail-value">+<?php echo e($subscription->plan->bonus_days); ?> days</span>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            <center>
                <a href="<?php echo e(route('supplier.dashboard')); ?>" class="btn">
                    Go to Dashboard →
                </a>
            </center>
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\emails\subscription\activated.blade.php ENDPATH**/ ?>