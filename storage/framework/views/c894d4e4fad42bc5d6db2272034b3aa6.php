...
<?php $component->withAttributes(['title' => 'Sign In']); ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <?php elseif(request()->filled('return_url')): ?>
            <input type="hidden" name="redirect" value="<?php echo e(request('return_url')); ?>">
        <?php elseif(session()->has('url.intended')): ?>
            <input type="hidden" name="redirect" value="<?php echo e(session('url.intended')); ?>">
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="mt-6 text-center text-sm text-gray-500">
        ...
        <a href="<?php echo e(route('register', array_filter(['redirect' => request('redirect') ?? request('return_url') ?? session('url.intended')]))); ?>" class="font-semibold text-indigo-600 hover:text-indigo-800 transition">Create account</a>
    </div>
