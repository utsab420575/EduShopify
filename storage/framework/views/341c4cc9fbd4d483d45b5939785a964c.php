<?php $__env->startSection('title', 'Permission Audit Logs'); ?>
<?php $__env->startSection('breadcrumb', 'Access Control / Permission Audit Logs'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.empty-state','data' => ['icon' => 'fa-shield-halved','title' => 'No RBAC audit logs recorded']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-shield-halved','title' => 'No RBAC audit logs recorded']); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $act): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr class="hover:bg-gray-50">
                    <td class="px-6 py-3.5 text-xs text-gray-500 font-mono">
                        <?php echo e($act->created_at->format('M d, Y H:i:s')); ?>

                    </td>
                    <td class="px-6 py-3.5">
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold
                            <?php echo e($action === 'role_created' ? 'bg-emerald-100 text-emerald-800' : ($action === 'role_duplicated' ? 'bg-amber-100 text-amber-800' : ($action === 'permissions_synced' ? 'bg-blue-100 text-blue-800' : 'bg-purple-100 text-purple-800'))); ?>">
                            <?php echo e(str_replace('_', ' ', ucfirst($action ?: 'update'))); ?>

                        </span>
                    </td>
                    <td class="px-6 py-3.5 text-xs font-bold text-gray-900">
                        <?php echo e($act->causer?->name ?? 'System'); ?>

                    </td>
                    <td class="px-6 py-3.5 text-xs text-gray-700">
                        <?php echo e($act->description); ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($act->properties['added_permissions'] ?? [])): ?>
                            <div class="mt-1 text-[11px] text-emerald-700">
                                <strong>+ Added:</strong> <?php echo e(implode(', ', $act->properties['added_permissions'])); ?>

                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($act->properties['removed_permissions'] ?? [])): ?>
                            <div class="mt-0.5 text-[11px] text-rose-700">
                                <strong>- Removed:</strong> <?php echo e(implode(', ', $act->properties['removed_permissions'])); ?>

                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </td>
                    <td class="px-6 py-3.5 text-xs text-gray-400 font-mono">
                        <?php echo e($act->properties['ip_address'] ?? '—'); ?>
...
<?php echo $__env->make('backend.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\admin\access-control\audit-logs\index.blade.php ENDPATH**/ ?>