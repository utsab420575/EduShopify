<?php $__env->startSection('title', 'Achievement Requests'); ?>
<?php $__env->startSection('breadcrumb', 'Achievements / Achievement Requests'); ?>

<?php $__env->startSection('body'); ?>

    <?php if (isset($component)) { $__componentOriginal6ccefb989a1afce853acb3cdbc40307e = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal6ccefb989a1afce853acb3cdbc40307e = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.page-header','data' => ['title' => 'Achievement Requests','subtitle' => 'Accounts claiming a badge from the achievements catalogue.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Achievement Requests','subtitle' => 'Accounts claiming a badge from the achievements catalogue.']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.tab','data' => ['href' => route('admin.achievement-requests.index', array_filter(['search' => $search])),'active' => $status === '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.achievement-requests.index', array_filter(['search' => $search]))),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($status === '')]); ?>
...
<?php endif; ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['pending' => 'Pending', 'approved' => 'Approved', 'rejected' => 'Rejected']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if (isset($component)) { $__componentOriginalfda544832f91f39c42466108e87ef294 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalfda544832f91f39c42466108e87ef294 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.tab','data' => ['href' => route('admin.achievement-requests.index', array_filter(['status' => $value, 'search' => $search])),'active' => $status === $value]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('backend.tab'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.achievement-requests.index', array_filter(['status' => $value, 'search' => $search]))),'active' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($status === $value)]); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.empty-state','data' => ['icon' => 'fa-trophy','title' => 'No achievement requests found']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'fa-trophy','title' => 'No achievement requests found']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
        ...
        <?php else: ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="hover:bg-gray-50">
                    <td class="px-5 py-3.5 text-sm font-medium text-gray-900"><?php echo e($req->account?->display_name); ?></td>
                    <td class="px-5 py-3.5 text-sm text-gray-600">
                        <span class="inline-flex items-center gap-1.5">
                            <i class="fa-solid <?php echo e($req->achievement?->badge_icon ?: 'fa-trophy'); ?> text-amber-500 text-xs"></i>
                            <?php echo e($req->achievement?->name); ?>

                        </span>
                    </td>
                    <td class="px-5 py-3.5 text-sm text-gray-600"><?php echo e($req->requested_at?->format('d M Y') ?? $req->created_at->format('d M Y')); ?></td>
                    <td class="px-5 py-3.5 text-sm text-gray-600"><?php echo e($req->reviewedBy?->name ?? '—'); ?></td>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.status-badge','data' => ['status' => $req->status]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($req->status)]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?></td>
                    <td class="px-5 py-3.5 text-right">
                        <div class="flex items-center justify-end gap-1.5">
                            <button type="button"
                                    @click="$dispatch('open-modal-view-achievement-request-<?php echo e($req->id); ?>')"
                                    title="View"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->status === 'pending'): ?>
                                <form method="POST" action="<?php echo e(route('admin.achievement-requests.approve', $req)); ?>" onsubmit="return confirmSwal(this, 'Approve Claim?', 'Approve <?php echo e(addslashes($req->account?->display_name)); ?>\'s claim on <?php echo e(addslashes($req->achievement?->name)); ?>?', 'question', 'Yes, Approve')">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form method="POST" action="<?php echo e(route('admin.achievement-requests.reject', $req)); ?>" onsubmit="return confirmSwal(this, 'Reject Claim?', 'Reject <?php echo e(addslashes($req->account?->display_name)); ?>\'s claim on <?php echo e(addslashes($req->achievement?->name)); ?>?', 'warning', 'Yes, Reject')">
                                    <?php echo csrf_field(); ?>
                            ...
                            <?php else: ?>
                                <form method="POST" action="<?php echo e(route('admin.achievement-requests.undo', $req)); ?>" onsubmit="return confirmSwal(this, 'Undo Decision?', 'Revert <?php echo e(addslashes($req->account?->display_name)); ?>\'s claim on <?php echo e(addslashes($req->achievement?->name)); ?> back to Pending?', 'question', 'Yes, Undo')">
                                    <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.pagination','data' => ['paginator' => $requests]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.modal','data' => ['id' => 'view-achievement-request-'.$req->id,'title' => 'Achievement Claim — '.$req->account?->display_name,'width' => 'max-w-lg']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('view-achievement-request-'.$req->id),'title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Achievement Claim — '.$req->account?->display_name),'width' => 'max-w-lg']); ?>
            <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                <div><dt class="text-xs text-gray-500">Account</dt><dd class="font-medium text-gray-900"><?php echo e($req->account?->display_name); ?></dd></div>
                <div><dt class="text-xs text-gray-500">Achievement</dt><dd class="font-medium text-gray-900"><?php echo e($req->achievement?->name); ?></dd></div>
...
<?php unset($__componentOriginal1790892cf8031768f200c26522db45cd); ?>
<?php endif; ?></dd></div>
                <div><dt class="text-xs text-gray-500">Requested At</dt><dd class="font-medium text-gray-900"><?php echo e($req->requested_at?->format('d M Y, h:i A') ?? '—'); ?></dd></div>
                <div><dt class="text-xs text-gray-500">Reviewed By</dt><dd class="font-medium text-gray-900"><?php echo e($req->reviewedBy?->name ?? '—'); ?></dd></div>
                <div><dt class="text-xs text-gray-500">Earned At</dt><dd class="font-medium text-gray-900"><?php echo e($req->earned_at?->format('d M Y') ?? '—'); ?></dd></div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->achievement?->description): ?>
                    <div class="sm:col-span-2"><dt class="text-xs text-gray-500">Achievement Description</dt><dd class="text-xs text-gray-700 mt-0.5"><?php echo e($req->achievement->description); ?></dd></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->note): ?>
                    <div class="sm:col-span-2"><dt class="text-xs text-gray-500">Account Note</dt><dd class="text-xs text-gray-700 mt-0.5"><?php echo e($req->note); ?></dd></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($req->proof): ?>
                    <div class="sm:col-span-2"><dt class="text-xs text-gray-500">Proof</dt><dd><a href="<?php echo e(asset('storage/'.$req->proof)); ?>" target="_blank" class="text-xs text-indigo-600 hover:underline">View proof file</a></dd></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </dl>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('backend.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\admin\achievement-requests\index.blade.php ENDPATH**/ ?>