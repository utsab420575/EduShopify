<?php $__env->startSection('title', $category->name . ' — Specifications / Attributes'); ?>
<?php $__env->startSection('breadcrumb', 'Catalog & Taxonomy / Categories / ' . $category->name . ' / Specifications'); ?>
...
<?php $__env->startSection('body'); ?>
    ...
    <div class="mb-6">
        <div class="flex flex-wrap items-center justify-between gap-4 mb-4">
            <div>
                <div class="flex items-center gap-2">
                    ...
                    <span class="px-2.5 py-0.5 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700 border border-indigo-100">
                        <?php echo e($totalAssignedCount); ?> <?php echo e(Str::plural('Specification', $totalAssignedCount)); ?>
            ...
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('admin.catalog.categories.edit', $category)); ?>" class="inline-flex items-center gap-1.5 px-3.5 py-2 text-sm font-medium rounded-lg border border-gray-300 text-gray-700 hover:bg-gray-50 bg-white">
        ...
        <div class="border-b border-gray-200">
            <nav class="flex gap-6 -mb-px">
                <a href="<?php echo e(route('admin.catalog.categories.edit', $category)); ?>" class="py-3 text-sm font-medium text-gray-500 hover:text-gray-700 border-b-2 border-transparent">
                    General Information
                </a>
                <a href="<?php echo e(route('admin.catalog.categories.attributes.index', $category)); ?>" class="py-3 text-sm font-bold text-indigo-600 border-b-2 border-indigo-600 flex items-center gap-2">
                    <span>Specifications &amp; Attributes</span>
                    <span class="px-2 py-0.5 text-xs rounded-full bg-indigo-100 text-indigo-800 font-semibold"><?php echo e($totalAssignedCount); ?></span>
                </a>
            </nav>
        </div>
    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($groupedAttributes->isEmpty()): ?>
    ...
    <?php else: ?>
        <div class="space-y-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $groupedAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                    ...
                    <div class="flex items-center justify-between px-5 py-3.5 bg-gray-50/80 border-b border-gray-200">
                        <div class="flex items-center gap-2.5">
                            ...
                            <div>
                                <h3 class="text-sm font-bold text-gray-900"><?php echo e($groupData['group_name']); ?></h3>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($groupData['group']?->description): ?>
                                    <p class="text-[11px] text-gray-500"><?php echo e($groupData['group']->description); ?></p>
                        ...
                        <span class="text-xs font-medium text-gray-500 bg-white px-2.5 py-1 rounded-full border border-gray-200">
                            <?php echo e($groupData['attributes']->count()); ?> <?php echo e(Str::plural('field', $groupData['attributes']->count())); ?>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-gray-100 text-xs">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $groupData['attributes']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50/80 transition">
                                        <td class="px-5 py-3.5">
                                            <div class="font-semibold text-gray-900 text-sm"><?php echo e($attr->name); ?></div>
                                            <div class="text-[11px] text-gray-400 font-mono"><?php echo e($attr->slug); ?></div>
                                        </td>
                                        <td class="px-4 py-3.5">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($attr->input_type, ['select', 'multi_select', 'color'])): ?>
                                                <span class="text-[10px] text-gray-400 block mt-0.5">
                                                    <?php echo e($attr->values->count()); ?> options
                                                </span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </td>
                                        <td class="px-4 py-3.5 text-gray-600 font-medium">
                                            <?php echo e($attr->unit ? ($attr->unit->name . ' (' . $attr->unit->symbol . ')') : '—'); ?>

                                        </td>

                                        <td class="px-4 py-3.5 text-center">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($attr->pivot->is_required): ?>
                                        ...
                                        <td class="px-4 py-3.5 text-center">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($attr->pivot->is_filterable): ?>
                                        ...
                                        <td class="px-4 py-3.5 text-center">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($attr->pivot->is_variant): ?>
                                        ...
                                        <td class="px-4 py-3.5 text-center text-xs font-mono text-gray-700">
                                            <?php echo e($attr->pivot->sort_order); ?>

                                        </td>

                                        <td class="px-5 py-3.5 text-right">
                                            <div class="flex items-center justify-end gap-1.5">
                                                <button type="button" @click="$dispatch('open-modal-edit-attr-<?php echo e($attr->id); ?>')" class="w-8 h-8 rounded-lg inline-flex items-center justify-center text-gray-500 hover:bg-gray-100" title="Edit Specification Settings">
                                                    <i class="fa-regular fa-pen-to-square text-sm"></i>
                                                </button>
                                                <form method="POST" action="<?php echo e(route('admin.catalog.categories.attributes.destroy', [$category, $attr])); ?>" onsubmit="return confirm('Remove <?php echo e($attr->name); ?> from <?php echo e($category->name); ?>?');">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $assignedAttributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.modal','data' => ['id' => 'edit-attr-'.$attr->id,'title' => 'Edit Specification Settings']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('edit-attr-'.$attr->id),'title' => 'Edit Specification Settings']); ?>
            <div class="p-3 bg-gray-50 border border-gray-200 rounded-xl text-xs space-y-1 mb-4">
                <div class="flex justify-between"><span class="text-gray-500">Attribute:</span> <span class="font-semibold text-gray-900"><?php echo e($attr->name); ?></span></div>
                <div class="flex justify-between"><span class="text-gray-500">Group Section:</span> <span class="font-medium text-gray-800"><?php echo e($attr->attributeGroup?->name ?? 'General / Other Specifications'); ?></span></div>
                <div class="flex justify-between"><span class="text-gray-500">Input Type:</span> <span class="font-semibold text-blue-700 uppercase"><?php echo e(str_replace('_', ' ', $attr->input_type)); ?></span></div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($attr->unit): ?>
                    <div class="flex justify-between"><span class="text-gray-500">Unit:</span> <span class="font-medium text-gray-800"><?php echo e($attr->unit->name); ?> (<?php echo e($attr->unit->symbol); ?>)</span></div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>

            <form method="POST" action="<?php echo e(route('admin.catalog.categories.attributes.update', [$category, $attr])); ?>" class="space-y-4">
                ...
                <div class="border-t border-gray-100 pt-3 space-y-3">
                    ...
                    <div class="grid grid-cols-3 gap-2">
                        <label class="flex items-center gap-2 p-2 border border-gray-200 rounded-lg text-xs cursor-pointer hover:bg-gray-50">
                            <input type="checkbox" name="is_required" value="1" <?php if($attr->pivot->is_required): echo 'checked'; endif; ?> style="accent-color:var(--theme-primary)">
                            <span class="font-semibold">Required</span>
                        </label>
                        <label class="flex items-center gap-2 p-2 border border-gray-200 rounded-lg text-xs cursor-pointer hover:bg-gray-50">
                            <input type="checkbox" name="is_filterable" value="1" <?php if($attr->pivot->is_filterable): echo 'checked'; endif; ?> style="accent-color:var(--theme-primary)">
                            <span class="font-semibold">Filterable</span>
                        </label>
                        <label class="flex items-center gap-2 p-2 border border-gray-200 rounded-lg text-xs cursor-pointer hover:bg-gray-50">
                            <input type="checkbox" name="is_variant" value="1" <?php if($attr->pivot->is_variant): echo 'checked'; endif; ?> style="accent-color:var(--theme-primary)">
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" value="<?php echo e($attr->pivot->sort_order); ?>" placeholder="0" class="w-full text-xs rounded-lg border border-gray-300 px-3 py-2 bg-white">
                    </div>
                </div>
...
<?php endif; ?>
    ...
    <div x-data="{
        ...
        selectedGroup: '',
        selectedAttrId: '',
        attributesList: <?php echo e(Js::from($availableAttributes->map(fn($a) => [
            'id' => $a->id,
            'name' => $a->name,
    ...
    x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display: none;">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full border border-gray-100 overflow-hidden flex flex-col max-h-[88vh]"
            ...
            <div class="flex items-center justify-between px-6 pt-6 pb-4 border-b border-gray-100 shrink-0">
                <h3 class="text-base font-bold text-gray-900">Assign Attribute to <?php echo e($category->name); ?></h3>
            ...
            <div class="px-6 py-4 overflow-y-auto">
                ...
                <div x-show="activeTab === 'existing'">
                    <form method="POST" action="<?php echo e(route('admin.catalog.categories.attributes.store', $category)); ?>" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            ...
                            <div>
                                ...
                                <select x-model="selectedGroup" class="w-full text-sm rounded-lg border border-gray-300 px-3 py-2 bg-white">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $attributeGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div x-show="activeTab === 'create'">
                    <p class="text-xs text-gray-500 -mt-1 mb-4">
                        This creates a reusable attribute in the catalog dictionary (available to every category), and immediately assigns it to <strong><?php echo e($category->name); ?></strong>.
                    </p>

                    <form method="POST" action="<?php echo e(route('admin.catalog.attributes.store')); ?>" class="space-y-4">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="redirect_to" value="<?php echo e(route('admin.catalog.categories.attributes.index', $category)); ?>">
                        <input type="hidden" name="assign_to_category_id" value="<?php echo e($category->id); ?>">
    ...
    <div x-data="{
        open: false,
        groups: <?php echo e(Js::from($attributeGroups->map(fn($g) => [
            'id' => $g->id,
            'name' => $g->name,
    ...
    x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display: none;">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-xl w-full p-6 border border-gray-100 overflow-hidden"
            ...
            <form method="POST" action="<?php echo e(route('admin.catalog.categories.attributes.bulk-store', $category)); ?>" class="space-y-4 pt-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\admin\catalog\categories\attributes.blade.php ENDPATH**/ ?>