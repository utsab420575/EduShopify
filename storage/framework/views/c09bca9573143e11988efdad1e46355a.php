<?php $__env->startSection('title', 'All Roles in Permission'); ?>
<?php $__env->startSection('breadcrumb', 'Access Control / All Roles in Permission'); ?>
...
<?php $__env->startSection('body'); ?>
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
        ...
        <a href="<?php echo e(route('admin.access-control.roles-in-permission.create')); ?>" class="btn-primary text-sm font-semibold px-4 py-2.5 rounded-xl flex items-center gap-2">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="hover:bg-gray-50/70 transition-colors">
                    <td class="px-6 py-3.5">
                        <div class="font-bold text-gray-900 text-sm"><?php echo e($role->display_name ?? $role->name); ?></div>
                        <div class="text-[11px] text-gray-400 font-mono"><?php echo e($role->name); ?></div>
                    </td>
                    <td class="px-6 py-3.5">
                    ...
                    <td class="px-6 py-3.5 text-right">
                        <a href="<?php echo e(route('admin.access-control.roles-in-permission.edit', $role)); ?>" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-indigo-600 bg-indigo-50 hover:bg-indigo-100 rounded-lg transition-colors">
...
<?php echo $__env->make('backend.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\admin\access-control\roles-in-permission\index.blade.php ENDPATH**/ ?>