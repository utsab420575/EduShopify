...
<?php $component->withAttributes(['title' => 'Transfer Ownership']); ?>
            <form method="POST" action="<?php echo e(route('supplier.ownership.transfer')); ?>" class="space-y-4">
                <?php echo csrf_field(); ?>
                <div>
...
<?php endif; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($transfer->status === 'pending' && $transfer->to_user_id === auth()->id()): ?>
                                <form method="POST" action="<?php echo e(route('supplier.ownership.accept', $transfer)); ?>">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="text-xs font-medium text-green-700">Accept</button>
                                </form>
                                <form method="POST" action="<?php echo e(route('supplier.ownership.reject', $transfer)); ?>">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="text-xs font-medium text-red-600">Decline</button>
                                </form>
                            <?php elseif($transfer->status === 'pending'): ?>
                                <form method="POST" action="<?php echo e(route('supplier.ownership.cancel', $transfer)); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('backend.layouts.supplier', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\edushopify\resources\views\backend\supplier\organization\ownership\index.blade.php ENDPATH**/ ?>