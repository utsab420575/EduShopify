...
<div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
    <div class="relative bg-gray-50 flex items-center justify-center" style="min-height: 320px; max-height: 420px;">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($firstMedia): ?>
            <img :src="heroUrl" alt="<?php echo e($listing->name); ?>" class="w-full object-contain transition-all duration-300" style="max-height: 420px;">
        <?php else: ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($heroFirst->count() > 1): ?>
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\backend\buyer\marketplace\products\partials\_hero.blade.php ENDPATH**/ ?>