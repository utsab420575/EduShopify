...
<div x-data="productListingWizard({
    isEdit: <?php echo e(json_encode($isEdit)); ?>,
    listingId: <?php echo e(json_encode($isEdit ? $listing->id : null)); ?>,
    currentStep: <?php echo e($currentStep); ?>,
    maxCompletedStep: <?php echo e(json_encode($isEdit ? $listing->setup_step : 1)); ?>,
    listingType: <?php echo e(json_encode($isEdit ? ($listing->listing_type_id ?? '') : old('listing_type_id', ''))); ?>,
    productTypeId: <?php echo e(json_encode((string) ($listingTypes->firstWhere('code', 'product')?->id ?? ''))); ?>,
    serviceTypeId: <?php echo e(json_encode((string) ($listingTypes->firstWhere('code', 'service')?->id ?? ''))); ?>,
    primaryImageId: <?php echo e(json_encode($isEdit ? $listing->primary_image_media_id : null)); ?>,
    mediaItems: <?php echo e(json_encode($mediaList)); ?>,
    pricingType: <?php echo e(json_encode($isEdit ? ($listing->pricing_type_id ?? '') : old('pricing_type_id', ''))); ?>,
    hasTierPricing: <?php echo e(json_encode($isEdit ? $listing->globalTierPrices->isNotEmpty() : false)); ?>,
    tierPrices: <?php echo e(json_encode($tierPricesList)); ?>,
    variants: <?php echo e(json_encode($variantsList)); ?>,
    categoryNodes: <?php echo e(json_encode($categoryOptions)); ?>,
    selectedCategoryId: <?php echo e(json_encode($isEdit ? $listing->main_category_id : null)); ?>,
    selectedCategoryPath: <?php echo e(json_encode($isEdit && $listing->mainCategory ? $listing->mainCategory->getBreadcrumbPath() : '')); ?>,
    step1Url: '<?php echo e(route('supplier.catalog.listings.wizard.step1')); ?>',
    step2Url: '<?php echo e($isEdit ? route('supplier.catalog.listings.wizard.step2', $listing) : ''); ?>',
    step3Url: '<?php echo e($isEdit ? route('supplier.catalog.listings.wizard.step3', $listing) : ''); ?>',
    step4Url: '<?php echo e($isEdit ? route('supplier.catalog.listings.wizard.step4', $listing) : ''); ?>',
    previewUrl: '<?php echo e($isEdit ? route('supplier.catalog.listings.show', $listing) : ''); ?>',
    setCoverUrl: '<?php echo e($isEdit ? route('supplier.catalog.listings.media.primary', $listing) : ''); ?>',
    uploadMediaUrl: '<?php echo e($isEdit ? route('supplier.catalog.listings.media.store', $listing) : ''); ?>',
    lastSavedTime: <?php echo e(json_encode($isEdit && $listing->last_autosaved_at ? $listing->last_autosaved_at->toISOString() : null)); ?>,
    currencyCode: <?php echo e(json_encode($isEdit ? ($listing->currency_code ?: 'USD') : 'USD')); ?>,
    unitId: <?php echo e(json_encode($isEdit ? ($listing->unit_id ? (string)$listing->unit_id : '') : '')); ?>
...
class="space-y-6">
    ...
    <div x-show="listingType == '<?php echo e($listingTypes->firstWhere('code','service')?->id ?? ''); ?>' && currentStep > 1" x-cloak class="bg-amber-50 border border-amber-200 rounded-xl p-3 flex items-center gap-2.5 text-xs text-amber-800">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.form-card','data' => ['title' => 'Listing Type & Basic Details','class' => 'flex flex-col xl:max-h-[70vh]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Listing Type & Basic Details','class' => 'flex flex-col xl:max-h-[70vh]']); ?>
                        <div class="space-y-5 flex-1 min-h-0 overflow-y-auto pr-1">
                            <div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($listingTypes) && $listingTypes->isNotEmpty()): ?>
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $listingTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        ...
                                        <label class="flex items-start gap-3 p-3.5 border-2 rounded-xl transition-all"
                                               :class="[listingType == '<?php echo e($lt->id); ?>' ? 'border-indigo-600 bg-indigo-50/40 ring-1 ring-indigo-500' : 'border-gray-200 bg-white hover:bg-gray-50',
                                                        <?php echo e($isService ? "!wasServiceOnLoad ? 'opacity-70 cursor-not-allowed' : 'cursor-pointer'" : "'cursor-pointer'"); ?>].join(' ')">
                                            <input type="radio" name="listing_type_id" value="<?php echo e($lt->id); ?>"
                                                   x-model="listingType"
                                                   <?php echo e($isService ? ':disabled="!wasServiceOnLoad"' : ''); ?>
                                            ...
                                            <div>
                                                <p class="text-sm font-bold text-gray-900 flex items-center gap-2">
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isService): ?><span x-show="!wasServiceOnLoad" class="text-[10px] font-bold uppercase tracking-wide text-amber-700 bg-amber-100 px-1.5 py-0.5 rounded">Coming Soon</span><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </p>
                                                <p class="text-xs text-gray-500 mt-0.5"><?php echo e($lt->description); ?></p>
                                            </div>
                                        </label>
                            ...
                            <div>
                                ...
                                <input type="text" name="name" required placeholder="e.g. Digital Microscope Pro 4K with LED Stage"
                                       value="<?php echo e($isEdit ? $listing->name : old('name')); ?>"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="brand_id" class="w-full text-sm rounded-lg border border-gray-300 px-3 py-2.5 bg-white focus-accent"
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($brand->id); ?>" <?php if($isEdit && $listing->brand_id == $brand->id): echo 'selected'; endif; ?>><?php echo e($brand->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="sku" placeholder="e.g. MIC-4K-2026"
                                           value="<?php echo e($isEdit ? $listing->sku : old('sku')); ?>"
                                           class="focus-accent w-full px-3.5 py-2.5 border rounded-lg text-sm text-gray-900 placeholder:text-gray-400"
                            ...
                            <div>
                                ...
                                <textarea name="short_description" rows="2" placeholder="1-2 sentences highlighting core features and suitability."
                                          ...
                                          :class="fieldErrors['short_description'] ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-300'"><?php echo e($isEdit ? $listing->short_description : old('short_description')); ?></textarea>
                            ...
                            <div>
                                ...
                                <textarea name="description" rows="4" placeholder="Full technical overview, package contents, usage guidelines..."
                                          class="focus-accent w-full px-3.5 py-2 border rounded-lg text-sm text-gray-900 placeholder:text-gray-400"
                                          :class="fieldErrors['description'] ? 'border-red-500 ring-1 ring-red-500' : 'border-gray-300'"><?php echo e($isEdit ? $listing->description : old('description')); ?></textarea>
...
<?php endif; ?>
                ...
                <div class="xl:col-span-4 space-y-6 flex flex-col">
                    <?php if (isset($component)) { $__componentOriginal3c6ebeac636fe1a833069360516dddbb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3c6ebeac636fe1a833069360516dddbb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.backend.form-card','data' => ['title' => 'Product Photos & Gallery','class' => 'flex flex-col xl:max-h-[70vh]']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('backend.form-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Product Photos & Gallery','class' => 'flex flex-col xl:max-h-[70vh]']); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:items-stretch">
                ...
                <div class="lg:col-span-7 bg-white rounded-2xl border border-gray-200 p-5 shadow-2xs flex flex-col lg:max-h-[70vh]">
                    ...
                    <div class="flex-1 min-h-0 overflow-y-auto pr-1 pt-4">
                        <?php echo $__env->make('backend.supplier.catalog.listings.partials.attributes-form', [
        ...
        <form @submit.prevent="submitStep3" id="step3Form" class="space-y-4">
            <div class="bg-white rounded-2xl border border-gray-200 p-4 sm:p-5 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($pricingTypes) && $pricingTypes->isNotEmpty()): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $pricingTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="p-2.5 border rounded-lg cursor-pointer transition-all flex items-start gap-2"
                               :class="pricingType == '<?php echo e($pt->id); ?>' ? 'border-indigo-600 bg-indigo-50/40 ring-1 ring-indigo-500' : 'border-gray-200 hover:bg-gray-50'">
                            <input type="radio" name="pricing_type_id" value="<?php echo e($pt->id); ?>" x-model="pricingType" class="mt-0.5" style="accent-color:var(--theme-primary)">
                            <span>
                                <span class="block text-xs font-bold text-gray-900"><?php echo e($pt->name); ?></span>
                                <span class="block text-[11px] text-gray-500 mt-0.5"><?php echo e($pt->description); ?></span>
                            </span>
                        </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php else: ?>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-3 border-t border-gray-100">
                    <div>
                        ...
                        <select name="currency_code" required x-model="currencyCode"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($currencies) && count($currencies)): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $curr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($curr->code); ?>"><?php echo e($curr->code); ?> - <?php echo e($curr->name); ?> (<?php echo e($curr->symbol); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            <?php else: ?>
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="base_price" placeholder="0.00" value="<?php echo e($isEdit ? $listing->base_price : ''); ?>"
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" name="compare_at_price" placeholder="0.00" value="<?php echo e($isEdit ? $listing->compare_at_price : ''); ?>"
                               class="focus-accent w-full px-3 py-1.5 border rounded-lg text-sm text-gray-900"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input type="number" name="min_order_quantity" min="1" value="<?php echo e($isEdit ? $listing->min_order_quantity : '1'); ?>"
                               class="focus-accent w-full px-3 py-1.5 border rounded-lg text-sm text-gray-900"
                    ...
                    <div>
                        ...
                        <select name="unit_id" x-model="unitId"
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($unit->id); ?>"><?php echo e($unit->name); ?> (<?php echo e($unit->symbol); ?>)</option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <div>
                            ...
                            <select name="stock_status" class="w-full text-sm rounded-lg border border-gray-300 px-3 py-1.5 bg-white"
                                ...
                                <option value="in_stock" <?php if($isEdit && $listing->productDetail?->stock_status === 'in_stock'): echo 'selected'; endif; ?>>In Stock</option>
                                <option value="on_request" <?php if($isEdit && $listing->productDetail?->stock_status === 'on_request'): echo 'selected'; endif; ?>>On Request / Made to Order</option>
                                <option value="limited" <?php if($isEdit && $listing->productDetail?->stock_status === 'limited'): echo 'selected'; endif; ?>>Limited Availability</option>
                                <option value="out_of_stock" <?php if($isEdit && $listing->productDetail?->stock_status === 'out_of_stock'): echo 'selected'; endif; ?>>Out of Stock</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="number" name="stock_quantity" placeholder="0" value="<?php echo e($isEdit ? $listing->productDetail?->stock_quantity : ''); ?>"
                        ...
                        <div>
                            ...
                            <input type="number" name="lead_time_days" placeholder="e.g. 5" value="<?php echo e($isEdit ? $listing->productDetail?->lead_time_days : ''); ?>"
                                   class="focus-accent w-full px-3 py-1.5 border rounded-lg text-sm"
...
function productListingWizard(config) {
    return {
        ...
        async loadVariantAttributes(categoryId) {
            ...
            try {
                const url = '<?php echo e(route('supplier.catalog.listings.category.attributes', '__CAT__')); ?>'.replace('__CAT__', categoryId);
        ...
        async deleteMedia(mediaId, index) {
            ...
            try {
                const deleteUrl = '<?php echo e(url('supplier/catalog/listings')); ?>/' + this.listingId + '/media/' + mediaId;
        ...
        async saveStep1(isDraftOnly = false) {
            ...
            try {
                ...
                this.step2Url = '<?php echo e(url('supplier/catalog/listings')); ?>/' + data.listing_id + '/wizard/step-2';
                this.step3Url = '<?php echo e(url('supplier/catalog/listings')); ?>/' + data.listing_id + '/wizard/step-3';
                this.step4Url = '<?php echo e(url('supplier/catalog/listings')); ?>/' + data.listing_id + '/wizard/step-4';
                this.setCoverUrl = '<?php echo e(url('supplier/catalog/listings')); ?>/' + data.listing_id + '/media/primary';
        ...
        async previewListing() {
            ...
            this.previewHtml = '';
            try {
                const previewUrl = '<?php echo e(url('supplier/catalog/listings')); ?>/' + this.listingId + '/preview';
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\backend\supplier\catalog\listings\wizard.blade.php ENDPATH**/ ?>