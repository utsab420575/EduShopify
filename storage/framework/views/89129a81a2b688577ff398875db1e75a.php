...
<body>
    <div class="container">
        ...
        <div class="body">
            <p>Hello <?php echo e($recipientUser->name); ?>,</p>
            <p>You have <strong><?php echo e($totalUnreadCount); ?></strong> unread message<?php echo e($totalUnreadCount > 1 ? 's' : ''); ?> waiting for your response on <?php echo e(config('app.name')); ?>:</p>

            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $digestItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card">
                    <div class="card-header">
                        <span><?php echo e($item['sender_account']); ?> (<?php echo e($item['sender_name']); ?>)</span>
                        <span class="badge"><?php echo e($item['unread_count']); ?> new</span>
                    </div>
                    <div class="card-preview">
                        "<?php echo e($item['latest_message']); ?>"
                    </div>
                    <div style="font-size: 11px; color: #64748b;">
                        <?php echo e($item['latest_time']); ?>
            ...
            <div style="text-align: center;">
                <a href="<?php echo e(url('/')); ?>" class="btn" style="color: #ffffff;">Open Messages</a>
            </div>
        </div>
        <div class="footer">
...
<?php /**PATH C:\laragon\www\edushopify\resources\views\emails\messages\unread-digest.blade.php ENDPATH**/ ?>