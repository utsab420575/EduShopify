        ...
        <div class="relative">
            ...
            <div x-show="notifOpen" @click.outside="notifOpen=false" x-transition x-cloak
                ...
                <div class="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.notifications.index') }}" class="text-xs font-medium" style="color:var(--theme-primary)">View all</a>
                </div>
                <div class="max-h-72 overflow-y-auto divide-y divide-gray-100">
                    @forelse(($topbarNotifications ?? []) as $notification)
                        <a href="{{ route('admin.notifications.index') }}" class="flex gap-3 px-4 py-3 hover:bg-gray-50">
                ...
                <a href="{{ route('admin.notifications.index') }}" class="block text-center text-xs font-medium py-2.5 border-t border-gray-100" style="color:var(--theme-primary)">View all notifications</a>
            </div>
        </div>
        ...
        <div class="relative">
            <button @click="profileOpen = !profileOpen; notifOpen=false" class="flex items-center gap-2 pl-2 pr-1 py-1 rounded-xl hover:bg-gray-100">
                ...
                <span class="hidden sm:block text-left leading-tight">
                    ...
                    <span class="block text-[10px] text-gray-400">{{ $user->roles->first()?->display_name ?? 'Admin' }}</span>
                </span>
            ...
            <div x-show="profileOpen" @click.outside="profileOpen=false" x-transition x-cloak
                ...
                <a href="{{ route('admin.system.settings.index') }}" class="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"><i class="fa-solid fa-gear w-4 text-gray-400"></i>Settings</a>
