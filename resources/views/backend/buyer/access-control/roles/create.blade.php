...
@section('body')
    ...
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <form method="POST" action="{{ route('buyer.roles.store') }}" class="space-y-6">
            @csrf
            ...
            <div class="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="display_name" value="{{ old('display_name') }}" required placeholder="e.g. Senior Procurement Officer" class="w-full px-4 py-2.5 rounded-xl border border-gray-300 text-sm focus:ring-2 focus:ring-indigo-500 focus:outline-none">
                    </div>
                    <div>
