{{-- ── 4. Gallery & Videos ── --}}
<div class="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden" x-data="{ open: {{ $spAccOpen('gallery', false) }} }" x-init="$watch('open', v => localStorage.setItem('sp-acc-gallery', v ? '1' : '0'))">
