{{--
    Lightweight public-frontend toast notification system.
    Positioned in the TOP RIGHT corner matching the requested design:
    white card, circular checkmark badge, action link, and subtle close button.
--}}
<div
    x-data="{
        toasts: [],
