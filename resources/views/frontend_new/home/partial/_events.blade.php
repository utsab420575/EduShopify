...
<section class="max-w-7xl mx-auto px-4 py-14" id="home-articles-section">
  ...
  <div class="flex justify-end mb-5">
    <a href="{{ route('v2.blogs.index') }}" class="text-emerald-600 hover:text-emerald-700 text-sm font-semibold hover:underline inline-flex items-center gap-1 group">
        ...
        <div class="p-4 flex-1 flex flex-col justify-between">
          <div>
            ...
            <div class="flex items-center gap-2 mb-2 text-[11px] text-gray-500">
              ...
              <span class="font-medium text-gray-700 truncate max-w-[110px]">{{ $authorName }}</span>
          ...
          {{-- Bottom Row: Read Time & Interactive Action --}}
