{{-- Hero Section: Title, Search, Popular Tags, and Statistics --}}
<section class="relative bg-gray-950 text-white py-14 px-4 overflow-hidden">
  {{-- Background Image --}}
  <img
    src="{{ asset('storage/System_Files/Resources/background.jpg') }}"
  ...
  <div class="relative z-10 max-w-7xl mx-auto">
    ...
    <nav class="flex items-center gap-2 text-xs text-gray-400 mb-4">
      <a href="{{ route('v2.home') }}" class="hover:text-emerald-400 transition-colors">Home</a>
      <span>&rsaquo;</span>
